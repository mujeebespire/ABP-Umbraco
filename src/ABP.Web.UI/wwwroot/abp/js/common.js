!function (n, t) {
    ...
    function dr(n, t, i) {
        ...
        if (void 0 === i && 1 === n.nodeType)
            if (r = "data-" + t.replace(ue, "-$&").toLowerCase(),
                ...
                try {
                    i = function (n) {
                        return "true" === n || "false" !== n && ("null" === n ? null : n === +n + "" ? +n : re.test(n) ? JSON.parse(n) : n)
                    }(i)
                } catch (n) { }
                o.set(n, t, i)
            } else
        ...
        for (var e, u, f = [], i = 0, o = n.length; i < o; i++)
            (u = n[i]).style && (e = u.style.display,
                t ? ("none" === e && (f[i] = r.get(u, "display") || null,
                    f[i] || (u.style.display = "")),
                    "" === u.style.display && ti(u) && (f[i] = fe(u))) : "none" !== e && (f[i] = "none",
                        r.set(u, "display", e)));
        for (i = 0; i < o; i++)
    ...
    function hu(n, t) {
        return v(n, "table") && v(11 !== t.nodeType ? t : t.firstChild, "tr") && i(n).children("tbody")[0] || n
    }
    function ae(n) {
    ...
    function ot(n, t, f, o) {
        ...
        if (k || y > 1 && "string" == typeof p && !e.checkClone && ce.test(p))
            return n.each(function (i) {
                var r = n.eq(i);
                k && (t[0] = p.call(this, i, r.html()));
                ot(r, t, f, o)
            });
        if (y && (w = (a = eu(t, n[0].ownerDocument, !1, n, o)).firstChild,
            1 === a.childNodes.length && (a = w),
            w || o)) {
            for (v = (l = i.map(s(a, "script"), ae)).length; c < y; c++)
                h = a,
                    c !== d && (h = i.clone(h, !0, !0),
            ...
            if (v)
                for (b = l[l.length - 1].ownerDocument,
                    ...
                    c = 0; c < v; c++)
                    h = l[c],
                        uu.test(h.type || "") && !r.access(h, "globalEval") && i.contains(b, h) && (h.src && "module" !== (h.type || "").toLowerCase() ? i._evalUrl && i._evalUrl(h.src) : hr(h.textContent.replace(le, ""), b, h))
        }
        return n
    }
    function lu(n, t, r) {
    ...
    function yt(n, t, r) {
        ...
        return (r = r || ui(n)) && ("" !== (f = r.getPropertyValue(t) || r[t]) || i.contains(n.ownerDocument, n) || (f = i.style(n, t)),
            !e.pixelBoxStyles() && pi.test(f) && pe.test(t) && (o = u.width,
                s = u.minWidth,
                h = u.maxWidth,
    ...
    function bu(n) {
        var t = i.cssProps[n];
        return t || (t = i.cssProps[n] = function (n) {
            if (n in wu)
                return n;
    ...
    function tr(n, t, r, u) {
        ...
        if (Array.isArray(t))
            i.each(t, function (t, i) {
                r || ke.test(n) ? u(n, i) : tr(n + "[" + ("object" == typeof i && null != i ? t : "") + "]", i, r, u)
            });
            ...
            return t.first ? function (t, i, u) {
                ...
                : function (t, i, h) {
                    ...
                    if (h) {
                        ...
                        for (; t = t[r];)
                            if (1 === t.nodeType || o)
                                if (l = (y = t[f] || (t[f] = {}))[t.uniqueID] || (y[t.uniqueID] = {}),
                ...
                l(function (f, o, s, h) {
                    var a, l, v, w = [], p = [], b = o.length, d = f || function (n, t, i) {
                        for (var r = 0, f = t.length; r < f; r++)
                            u(n, t[r], i);
                        return i
                    }(t || "*", s.nodeType ? [s] : s, []), y = !n || !f && t ? d : wt(d, w, n, s, h), c = i ? e || (f ? n : b || r) ? [] : o : y;
                    if (i && i(y, c, s, h),
                        r)
                        for (a = wt(c, p),
                            r(a, [], s, h),
                    ...
                    if (f) {
                        if (e || n) {
                            ...
                            for (l = c.length; l--;)
                                (v = c[l]) && (a = e ? nt(f, v) : w[l]) > -1 && (f[a] = !(o[a] = v))
                        }
                    } else
                        c = wt(c === o ? c.splice(b, c.length) : c),
                            ...
                            : function (t, i, h) {
                                ...
                                if (k) {
                                    ...
                                    if (w = [o ? k.firstChild : k.lastChild],
                                        ...
                                        !1 === l)
                                        for (; (c = ++a && c && c[b] || (l = a = 0) || w.pop()) && ((e ? c.nodeName.toLowerCase() !== nt : 1 !== c.nodeType) || !++l || (g && ((d = (y = c[f] || (c[f] = {}))[c.uniqueID] || (y[c.uniqueID] = {}))[n] = [v, l]),
                                            c !== t));)
                                            ;
        ...
        return ki.prototype = t.filters = t.pseudos,
            ...
            ft = u.tokenize = function (n, i) {
                ...
                for (r = n,
                    h = [],
                    c = t.preFilter; r;) {
                    for (o in e && !(f = rr.exec(r)) || (f && (r = r.slice(f[0].length) || r),
                        h.push(s = [])),
                        e = !1,
            ...
            si = u.select = function (n, i, r, u) {
                ...
                if (r = r || [],
                    ...
                    for (o = vt.needsContext.test(n) ? 0 : f.length; o-- && (e = f[o],
                        !t.relative[l = e.type]);)
    ...
    i.Callbacks = function (n) {
        ...
        var f, r, c, e, t = [], s = [], o = -1, a = function () {
            for (e = e || n.once,
                c = f = !0; s.length; o = -1)
        ...
        html: function (n) {
            return p(this, function (n) {
                ...
                if (void 0 === n && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof n && !he.test(n) && !c[(ru.exec(n) || ["", ""])[1].toLowerCase()]) {
                    n = i.htmlPrefilter(n);
                    try {
                        for (; r < u; r++)
    ...
    i.each(["height", "width"], function (n, t) {
        i.cssHooks[t] = {
            get: function (n, r, u) {
                if (r)
                    return !we.test(i.css(n, "display")) || n.getClientRects().length && n.getBoundingClientRect().width ? du(n, t, u) : nu(n, be, function () {
                        return du(n, t, u)
                    })
            },
            set: function (n, r, u) {
    ...
    i.extend({
        attr: function (n, t, r) {
            ...
            if (3 !== e && 8 !== e && 2 !== e)
                return void 0 === n.getAttribute ? i.prop(n, t, r) : (1 === e && i.isXMLDoc(n) || (u = i.attrHooks[t.toLowerCase()] || (i.expr.match.bool.test(t) ? uf : void 0)),
    ...
    i.fn.extend({
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var n = this.type;
                return this.name && !i(this).is(":disabled") && ge.test(this.nodeName) && !de.test(n) && (this.checked || !iu.test(n))
            }).map(function (n, t) {
                var r = i(this).val();
    ...
    return rr.href = pt.href,
        i.extend({
            ...
            ajax: function (t, r) {
                ...
                if (tt.promise(e),
                    u.url = ((t || u.url || pt.href) + "").replace(fo, pt.protocol + "//"),
                ...
                for (g in (y = i.event && u.global) && 0 == i.active++ && i.event.trigger("ajaxStart"),
                    ...
                    u.hasContent = !uo.test(u.type),
                    o = u.url.replace(to, ""),
                    u.hasContent ? u.data && u.processData && 0 === (u.contentType || "").indexOf("application/x-www-form-urlencoded") && (u.data = u.data.replace(no, "+")) : (p = u.url.slice(o.length),
                        u.data && (u.processData || "string" == typeof u.data) && (o += (nr.test(o) ? "&" : "?") + u.data,
                            delete u.data),
                        !1 === u.cache && (o = o.replace(io, "$1"),
                            p = (nr.test(o) ? "&" : "?") + "_=" + sf++ + p),
                        u.url = o + p),
        ...
        i.parseHTML = function (n, t, r) {
            return "string" != typeof n ? [] : ("boolean" == typeof t && (r = t,
                ...
                u = !r && [],
                (o = ci.exec(n)) ? [t.createElement(o[1])] : (o = eu([n], t, u),
        ...
        i.proxy = function (n, t) {
            ...
            if ("string" == typeof t && (r = n[t],
                ...
                n = r),
                u(n))
                return f = d.call(arguments, 2),
                    (e = function () {
                        return n.apply(t || this, f.concat(d.call(arguments)))
                    }
    ...
    function (n) {
        ...
        u.prototype = {
            utils: {
                ...
                replaceDiacritics: function (n) {
                    for (var t = r.length; t--;)
                        n = n.toLowerCase().replace(r[t], f[t]);
                    return n
                },
                format: function (n) {
                    var t = arguments;
                    return ("" + n).replace(/\{(?:(\d+)|(\w+))\}/g, function (n, i, r) {
                        return r && t[1] ? t[1][r] : t[i]
                    })
                },
                nextEnabledItem: function (n, t) {
                    for (; n[t = (t + 1) % n.length].disabled;)
                        ;
                    return t
                },
                previousEnabledItem: function (n, t) {
                    for (; n[t = (t > 0 ? t : n.length) - 1].disabled;)
                        ;
                    return t
                },
                toDash: function (n) {
                ...
                triggerCallback: function (t, i) {
                    var r = i.element
                        , u = i.options["on" + t]
                        , f = [r].concat([].slice.call(arguments).slice(1));
                    n.isFunction(u) && u.apply(r, f);
                    n(r).trigger("selectric-" + this.toDash(t), f)
                },
                arrayToClassname: function (t) {
                    var i = n.grep(t, function (n) {
                        return !!n
                    });
                    return n.trim(i.join(" "))
                }
            },
            init: function (t) {
                var i = this;
                if (i.options = n.extend(!0, {}, n.fn.selectric.defaults, i.options, t),
                    ...
                    var r = n("<input/>", {
                        ...
                        , h = i.$element.wrap("<div/>").parent().append(f.prepend(e), u, r)
                        , o = n("<div/>", {
                    ...
                    i.options.nativeOnMobile && i.utils.isMobile() && (i.elements.input = void 0,
                        o.addClass(i.classes.prefix + "-is-native"),
                        i.$element.on("change", function () {
                            i.refresh()
                        }));
                    i.$element.on(i.eventTriggers).wrap(o);
            ...
            activate: function () {
                ...
                this.options.inheritOriginalWidth && n > 0 && this.elements.outerWrapper.width(n);
                this.unbindEvents();
            ...
            getClassNames: function () {
                var r = this
                    , t = r.options.customClass
                    , i = {};
                return n.each("Input Items Open Disabled TempShow HideSelect Wrapper Focus Hover Responsive Above Below Scroll Group GroupLabel".split(" "), function (n, u) {
                    var f = t.prefix + u;
                    i[u.toLowerCase()] = t.camelCase ? f : r.utils.toDash(f)
                }),
                    i.prefix = t.prefix,
                    i
            },
            setLabel: function () {
                var t = this, r = t.options.labelBuilder, u, i, f;
                t.state.multiple ? (u = n.isArray(t.state.currValue) ? t.state.currValue : [t.state.currValue],
                    u = 0 === u.length ? [0] : u,
                    i = n.map(u, function (i) {
                        return n.grep(t.lookupItems, function (n) {
                            return n.index === i
                        })[0]
                    }),
                    i = n.grep(i, function (t) {
                        return i.length > 1 || 0 === i.length ? "" !== n.trim(t.value) : t
                    }),
                    i = n.map(i, function (i) {
                        return n.isFunction(r) ? r(i) : t.utils.format(r, i)
                    }),
                    t.options.multiple.maxLabelEntries && (i.length >= t.options.multiple.maxLabelEntries + 1 ? (i = i.slice(0, t.options.multiple.maxLabelEntries)).push(n.isFunction(r) ? r({
                        text: "..."
                    }) : t.utils.format(r, {
                        text: "..."
                    })) : i.slice(i.length - 1)),
                    t.elements.label.html(i.join(t.options.multiple.separator))) : (f = t.lookupItems[t.state.currValue],
                        t.elements.label.html(n.isFunction(r) ? r(f) : t.utils.format(r, f)))
            },
            populate: function () {
                var t = this
                    , f = t.$element.children()
                    , e = t.$element.find("option")
                    , u = e.filter(":selected")
                    , r = e.index(u)
                    , i = 0
                    , o = t.state.multiple ? [] : 0;
                u.length > 1 && t.state.multiple && (r = [],
                    u.each(function () {
                        r.push(n(this).index())
                    }));
                t.state.currValue = ~r ? r : o;
                t.state.selectedIdx = t.state.currValue;
                t.state.highlightedIdx = t.state.currValue;
                t.items = [];
                t.lookupItems = [];
                f.length && (f.each(function (r) {
                    var u = n(this), f;
                    u.is("optgroup") ? (f = {
                        element: u,
                        label: u.prop("label"),
                        groupDisabled: u.prop("disabled"),
                        items: []
                    },
                        u.children().each(function (r) {
                            var u = n(this);
                            f.items[r] = t.getItemData(i, u, f.groupDisabled || u.prop("disabled"));
                            t.lookupItems[i] = f.items[r];
                            i++
                        }),
                        t.items[r] = f) : (t.items[r] = t.getItemData(i, u, u.prop("disabled")),
                            t.lookupItems[i] = t.items[r],
                            i++)
                }),
                    t.setLabel(),
                    t.elements.items.append(t.elements.itemsScroll.html(t.getItemsMarkup(t.items))))
            },
            getItemData: function (t, i, r) {
                return {
                    index: t,
                    element: i,
                    value: i.val(),
                    ...
                    text: i.html(),
                    slug: n.trim(this.utils.replaceDiacritics(i.html())),
                    alt: i.attr("data-alt"),
            ...
            getItemsMarkup: function (t) {
                var i = this
                    , r = "<ul>";
                return n.isFunction(i.options.listBuilder) && i.options.listBuilder && (t = i.options.listBuilder(t)),
                    n.each(t, function (t, u) {
                        void 0 !== u.label ? (r += i.utils.format('<ul class="{1}"><li class="{2}">{3}<\/li>', i.utils.arrayToClassname([i.classes.group, u.groupDisabled ? "disabled" : "", u.element.prop("class")]), i.classes.grouplabel, u.element.prop("label")),
                            n.each(u.items, function (n, t) {
                                r += i.getItemMarkup(t.index, t)
                            }),
                            r += "<\/ul>") : r += i.getItemMarkup(u.index, u)
                    }),
                    r + "<\/ul>"
            },
            getItemMarkup: function (t, i) {
                var r = this.options.optionsItemBuilder
                    , u = {
                        value: i.value,
                        text: i.text,
                        slug: i.slug,
                ...
                return this.utils.format('<li data-index="{1}" class="{2}">{3}<\/li>', t, this.utils.arrayToClassname([i.className, t === this.items.length - 1 ? "last" : "", i.disabled ? "disabled" : "", i.selected ? "selected" : ""]), n.isFunction(r) ? this.utils.format(r(i, this.$element, t), i) : this.utils.format(r, u))
            },
            ...
            bindEvents: function () {
                ...
                t.elements.outerWrapper.on("mouseenter.sl mouseleave.sl", function (i) {
                    n(this).toggleClass(t.classes.hover, "mouseenter" === i.type);
                    t.options.openOnHover && (clearTimeout(t.closeTimer),
                        "mouseleave" === i.type ? t.closeTimer = setTimeout(n.proxy(t.close, t), t.options.hoverIntentTimeout) : t.open())
                });
                t.elements.wrapper.on("click.sl", function (n) {
                    t.state.opened ? t.close() : t.open(n)
                });
                t.options.nativeOnMobile && t.utils.isMobile() || (t.$element.on("focus.sl", function () {
                    ...
                    t.elements.input.prop({
                        ...
                        disabled: !1
                    }).on("keydown.sl", n.proxy(t.handleKeys, t)).on("focusin.sl", function (n) {
                        t.elements.outerWrapper.addClass(t.classes.focus);
                        t.elements.input.one("blur", function () {
                            t.elements.input.blur()
                        });
                        t.options.openOnFocus && !t.state.opened && t.open(n)
                    }).on("focusout.sl", function () {
                        t.elements.outerWrapper.removeClass(t.classes.focus)
                    }).on("input propertychange", function () {
                        var r = t.elements.input.val()
                            , i = new RegExp("^" + t.utils.escapeRegExp(r), "i");
                        clearTimeout(t.resetStr);
                        t.resetStr = setTimeout(function () {
                            t.elements.input.val("")
                        }, t.options.keySearchTimeout);
                        r.length && n.each(t.items, function (n, r) {
                            if (!r.disabled) {
                                if (i.test(r.text) || i.test(r.slug))
                                    return t.highlight(n),
                                        !1;
                                if (r.alt)
                                    for (var f = r.alt.split("|"), u = 0; u < f.length && f[u]; u++)
                                        if (i.test(f[u].trim()))
                                            return t.highlight(n),
                                                !1
                            }
                ...
                t.$li.on({
                    ...
                    click: function () {
                        return t.select(n(this).data("index")),
                            !1
                    }
                })
            },
            handleKeys: function (t) {
                var i = t.which
                    , u = this.options.keys
                    , f = n.inArray(i, u.previous) > -1
                    , e = n.inArray(i, u.next) > -1
                    , s = n.inArray(i, u.select) > -1
                    , h = n.inArray(i, u.open) > -1
                    , r = this.state.highlightedIdx
                    , c = f && 0 === r || e && r + 1 === this.items.length
                    , o = 0;
                if (13 !== i && 32 !== i || t.preventDefault(),
                    f || e) {
                    if (!this.options.allowWrap && c)
                        return;
                    f && (o = this.utils.previousEnabledItem(this.lookupItems, r));
                    e && (o = this.utils.nextEnabledItem(this.lookupItems, r));
                    this.highlight(o)
                }
                if (s && this.state.opened)
                    return this.select(r),
                        void (this.state.multiple && this.options.multiple.keepMenuOpen || this.close());
                h && !this.state.opened && this.open()
            },
            refresh: function () {
                this.populate();
                this.activate();
            ...
            setOptionsDimensions: function () {
                var r = this.elements.items.closest(":visible").children(":hidden").addClass(this.classes.tempshow)
                    , n = this.options.maxHeight
                    , t = this.elements.items.outerWidth()
                    , i = this.elements.wrapper.outerWidth() - (t - this.elements.items.width());
                !this.options.expandToItemText || i > t ? this.finalWidth = i : (this.elements.items.css("overflow", "scroll"),
                ...
                this.elements.items.width(this.finalWidth).height() > n && this.elements.items.height(n);
                r.removeClass(this.classes.tempshow)
            },
            isInViewport: function () {
                if (!0 === this.options.forceRenderAbove)
                    ...
                    var n = i.scrollTop()
                        , u = i.height()
                        , t = this.elements.outerWrapper.offset().top
                        , f = t + this.elements.outerWrapper.outerHeight() + this.itemsHeight <= n + u
                        , e = t - this.itemsHeight > n
                        , r = !f && e
                        , o = !r;
                    this.elements.outerWrapper.toggleClass(this.classes.above, r);
                    this.elements.outerWrapper.toggleClass(this.classes.below, o)
                }
            },
            detectItemVisibility: function (t) {
                var f = this.$li.filter("[data-index]");
                this.state.multiple && (t = n.isArray(t) && 0 === t.length ? 0 : t,
                    t = n.isArray(t) ? Math.min.apply(Math, t) : t);
                var i = f.eq(t).outerHeight()
                    , r = f[t].offsetTop
                    , u = this.elements.itemsScroll.scrollTop()
                    , e = r + 2 * i;
                this.elements.itemsScroll.scrollTop(e > u + this.itemsHeight ? e - this.itemsHeight : r - i < u ? r - i : u)
            },
            open: function (i) {
                var r = this;
                ...
                i && (i.preventDefault(),
                    r.options.stopPropagation && i.stopPropagation());
                r.state.enabled && (r.setOptionsDimensions(),
                    n("." + r.classes.hideselect, "." + r.classes.open).children().selectric("close"),
                    r.state.opened = !0,
                    ...
                    i && "focusin" !== i.type && r.elements.input.focus(),
                    setTimeout(function () {
                        t.on("click.sl", n.proxy(r.close, r)).on("scroll.sl", n.proxy(r.isInViewport, r))
                    }, 1),
                    r.isInViewport(),
                    r.options.preventWindowScroll && t.on("mousewheel.sl DOMMouseScroll.sl", "." + r.classes.scroll, function (t) {
                        var i = t.originalEvent
                            , f = n(this).scrollTop()
                            , u = 0;
                        "detail" in i && (u = -1 * i.detail);
                        "wheelDelta" in i && (u = i.wheelDelta);
                        "wheelDeltaY" in i && (u = i.wheelDeltaY);
                        "deltaY" in i && (u = -1 * i.deltaY);
                        (f === this.scrollHeight - r.itemsInnerHeight && u < 0 || 0 === f && u > 0) && t.preventDefault()
                    }),
            ...
            change: function () {
                ...
                t.state.multiple ? (n.each(t.lookupItems, function (n) {
                    t.lookupItems[n].selected = !1;
                    t.$element.find("option").prop("selected", !1)
                }),
                    n.each(t.state.selectedIdx, function (n, i) {
            ...
            highlight: function (n) {
                ...
                void 0 === n || -1 === n || this.lookupItems[n].disabled || (t.eq(this.state.highlightedIdx = n).addClass("highlighted"),
                    this.detectItemVisibility(n),
                    this.utils.triggerCallback("Highlight", this))
            },
            select: function (t) {
                var i = this, u = i.$li.filter("[data-index]"), r;
                (i.utils.triggerCallback("BeforeSelect", i, t),
                    void 0 === t || -1 === t || i.lookupItems[t].disabled) || (i.state.multiple ? (i.state.selectedIdx = n.isArray(i.state.selectedIdx) ? i.state.selectedIdx : [i.state.selectedIdx],
                        r = n.inArray(t, i.state.selectedIdx),
                        -1 !== r ? i.state.selectedIdx.splice(r, 1) : i.state.selectedIdx.push(t),
                        u.removeClass("selected").filter(function (t) {
                            return -1 !== n.inArray(t, i.state.selectedIdx)
                        }).addClass("selected")) : u.removeClass("selected").eq(i.state.selectedIdx = t).addClass("selected"),
            ...
            destroy: function (n) {
                this.state && this.state.enabled && (this.elements.items.add(this.elements.wrapper).add(this.elements.input).remove(),
                    n || this.$element.removeData("selectric").removeData("value"),
                    this.$element.prop("tabindex", this.originalTabindex).off(".sl").off(this.eventTriggers).unwrap().unwrap(),
                    this.state.enabled = !1)
            }
        };
        n.fn.selectric = function (t) {
            return this.each(function () {
                var i = n.data(this, "selectric");
                i && !i.disableOnMobile ? "string" == typeof t && i[t] ? i[t]() : i.init(t) : n.data(this, "selectric", new u(this, t))
            })
        }
            ;
        n.fn.selectric.defaults = {
            onChange: function (t) {
                n(t).change()
            },
            maxHeight: 300,
    ...
    function (n, t) {
        var i = {
            ...
            init: function (t) {
                var r, u, i;
                t.originalEvent.origin.match(/vimeo/g) && "data" in t.originalEvent && (i = "string" === n.type(t.originalEvent.data) ? n.parseJSON(t.originalEvent.data) : t.originalEvent.data) && (r = this.setPlayerID(i)).length && (u = this.setVimeoAPIurl(r),
                    i.hasOwnProperty("event") && this.handleEvent(i, r, u),
                    i.hasOwnProperty("method") && this.handleMethod(i, r, u))
            },
            setPlayerID: function (t) {
                return n("iframe[src*=" + t.player_id + "]")
            },
            setVimeoAPIurl: function (n) {
                return "http" !== n.attr("src").substr(0, 4) ? "https:" + n.attr("src").split("?")[0] : n.attr("src").split("?")[0]
            },
            ...
            handleEvent: function (t, i, r) {
                ...
                switch (t.event.toLowerCase()) {
                    case "ready":
                        for (e in n._data(i[0], "events"))
                            e.match(/loadProgress|playProgress|play|pause|finish|seek|cuechange/) && i[0].contentWindow.postMessage(JSON.stringify({
                                method: "addEventListener",
                                value: e
                            }), r);
                        if (i.data("vimeoAPICall")) {
                            for (f = i.data("vimeoAPICall"),
                                u = 0; u < f.length; u++)
                                i[0].contentWindow.postMessage(JSON.stringify(f[u].message), f[u].api);
                            i.removeData("vimeoAPICall")
                        }
                        i.data("vimeoReady", !0);
                        i.triggerHandler("ready");
                        break;
                    case "seek":
            ...
            , r = n.fn.vimeoLoad = function () {
                var t = n(this).attr("src"), i, r;
                return null === t.match(/player_id/g) && (i = -1 === t.indexOf("?") ? "?" : "&",
                    r = n.param({
                        api: 1,
                        player_id: "vvvvimeoVideo-" + Math.floor(1e7 * Math.random() + 1).toString()
                    }),
                    n(this).attr("src", t + i + r)),
                    this
            }
            ;
        jQuery(document).ready(function () {
            n("iframe[src*='vimeo.com']").each(function () {
                r.call(this)
            })
        });
        ...
        n.vimeo = function (n, r, u) {
            var o, s, h, c, f = {}, l = i.catchMethods.methodreturn.length, e;
            return ("string" == typeof r && (f.method = r),
                void 0 !== typeof u && "function" != typeof u && (f.value = u),
                "iframe" === n.prop("tagName").toLowerCase() && f.hasOwnProperty("method")) && (n.data("vimeoReady") ? n[0].contentWindow.postMessage(JSON.stringify(f), i.setVimeoAPIurl(n)) : (e = n.data("vimeoAPICall") ? n.data("vimeoAPICall") : [],
                    e.push({
                        message: f,
                        api: i.setVimeoAPIurl(n)
                    }),
                    n.data("vimeoAPICall", e))),
                "get" !== r.toString().substr(0, 3) && "paused" !== r.toString() || "function" != typeof u || (o = l,
                    s = u,
                    h = i.catchMethods.count,
                    c = t.setInterval(function () {
                        i.catchMethods.methodreturn.length != o && (t.clearInterval(c),
                            s(i.catchMethods.methodreturn[h]))
                    }, 10),
                    i.catchMethods.count++),
                n
        }
            ;
    ...
    function (n) {
        ...
        (t = function () {
            ...
            return function (i, r) {
                ...
                u.defaults = {
                    ...
                    arrows: !0,
                    asNavFor: null,
                    prevArrow: '<button class="slick-prev" aria-label="Previous" type="button"><span class="icon font-ico-arrow-left"><\/span><\/button>',
                    nextArrow: '<button class="slick-next" aria-label="Next" type="button"><span class="icon font-ico-arrow-right"><\/span><\/button>',
                    autoplay: !1,
                    autoplaySpeed: 3e3,
                    centerMode: !1,
                    centerPadding: "50px",
        ...
        t.prototype.getNavTarget = function () {
            ...
            return t && null !== t && (t = n(t).not(this.$slider)),
                t
        }
            ;
        ...
        t.prototype.changeSlide = function (t, i) {
            ...
            f = r.slideCount % r.options.slidesToScroll != 0 ? 0 : (r.slideCount - r.currentSlide) % r.options.slidesToScroll,
            t.data.message) {
                case "previous":
        ...
        t.prototype.checkNavigable = function (n) {
            var t, i, r;
            if (i = 0,
                n > (t = this.getNavigableIndexes())[t.length - 1])
                n = t[t.length - 1];
            else
                for (r in t) {
                    if (n < t[r]) {
        ...
        t.prototype.cleanUpRows = function () {
            var t, n = this;
            n.options.rows > 0 && ((t = n.$slides.children().children()).removeAttr("style"),
        ...
        t.prototype.getSlideCount = function () {
            var i, r, u, t = this;
            return u = !0 === t.options.centerMode ? Math.floor(t.$list.width() / 2) : 0,
                r = -1 * t.swipeLeft + u,
                !0 === t.options.swipeToSlide ? (t.$slideTrack.find(".slick-slide").each(function (u, f) {
                    var e, o;
                    if (e = n(f).outerWidth(),
                        o = f.offsetLeft,
                        !0 !== t.options.centerMode && (o += e / 2),
                        r < o + e)
                        return i = f,
                            !1
                }),
            ...
            for (t.$slides.add(t.$slideTrack.find(".slick-cloned")).attr({
                ...
                null !== t.$dots && (t.$slides.not(t.$slideTrack.find(".slick-cloned")).each(function (i) {
                    ...
                    (n(this).attr({
                        ...
                        -1 !== f) && (u = "slick-slide-control" + t.instanceUid + f,
        ...
        t.prototype.initDotEvents = function () {
            var t = this;
            !0 === t.options.dots && t.slideCount > t.options.slidesToShow && (n("li", t.$dots).on("click.slick", {
                message: "index"
            }, t.changeSlide),
                !0 === t.options.accessibility && t.$dots.on("keydown.slick", t.keyHandler));
            !0 === t.options.dots && !0 === t.options.pauseOnDotsHover && t.slideCount > t.options.slidesToShow && n("li", t.$dots).on("mouseenter.slick", n.proxy(t.interrupt, t, !0)).on("mouseleave.slick", n.proxy(t.interrupt, t, !1))
        }
            ;
            ...
            if (t = t || !1,
                ...
                if (!1 === t && r.asNavFor(n),
                    ...
                    !1 === r.options.fade && (u = r.currentSlide,
                        !0 !== i && r.slideCount > r.options.slidesToShow ? r.animateSlide(e, function () {
                            r.postSlide(u)
                        }) : r.postSlide(u));
                    ...
                    !0 !== i && r.slideCount > r.options.slidesToShow ? r.animateSlide(h, function () {
                        r.postSlide(f)
                    }) : r.postSlide(f)
                }
        }
    ...
    function (n) {
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                addActiveClass: function () {
                    setTimeout(function () {
                        $(document).ready(function () {
                            var t = location.pathname, i, n;
                            if (1 !== t.lenght) {
                                if (i = location.pathname.split("/")[1],
                                    n = $('.nav__submenu-link[href*="' + i + '"]'),
                                    void 0 === n || 0 === n.length) {
                                    if (!(void 0 !== (n = $('.js-nav-link[href="' + t + '"]')) || n.length > 0))
                                        return;
                                    n.addClass("nav__link--current")
                                }
                                n.closest("li.has-children").find("a.js-nav-link").addClass("nav__link--current")
                            }
                        })
                    }, 50)
                }
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                acceptCookie: function () {
                    var n = this.$announcement.data("accept-cookie-url");
                    n && this.$announcement.on("click", "[announcement-cookie-close]", function () {
                        $.post(n, {})
                    })
                }
            };
            ...
            var r, u = (r = i(4)) && r.__esModule ? r : {
                ...
                downloadButtonClick: function () {
                    this.$downloadbtn.on("click", function () {
                        var n = $(this), t = n.data("file-guid"), i = n.data("recipient-guid"), r;
                        console.log(t);
                        console.log(i);
                        r = n.data("controller-url");
                ...
                handleLabelShow: function () {
                    $(document).on("input", ".js-download-input", function (n) {
                        var t = $(n.currentTarget)
                            , i = t.parent().find(".js-download-label");
                        "" !== t.val() ? i.addClass("download-form__input-label--show") : i.removeClass("download-form__input-label--show")
                    });
                    $(document).on("change", ".js-download-consent", function (n) {
                        var i = $(n.currentTarget)
                            , t = $(".js-download-consent-label").parent();
                        i.is(":checked") ? t.removeClass("download-form__input-holder--invalid") : t.addClass("download-form__input-holder--invalid")
                    })
                },
                closePopup: function () {
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                disableScroll: function () {
                    this.isScrollDisabled || (this.topScroll = $(window).scrollTop(),
        ...
        , function (n, t) {
            ...
            var i = {
                init: function () {
                    var n = $("html");
                    ("ontouchstart" in window || navigator.msMaxTouchPoints > 0) && window.matchMedia("screen and (max-width: 1024px)").matches ? n.addClass("touch") : n.addClass("no-touch")
                }
            };
            t.default = i
        }
        , function (n, t) {
            ...
            var i = {
                ...
                setHeights: function () {
                    var n = this;
                    this.$parentElement.each(function (t, i) {
                        var e = $(i), s = $(window).width(), f = 0, u, r, h, c, o, l, v, a;
                        switch (!0) {
                            case s > 1024:
                                f = parseInt(e.attr("data-equal-desk"));
                                break;
                            case s > 768 && s <= 1024:
                                f = parseInt(e.attr("data-equal-tablet"));
                                break;
                            case s <= 768:
                                f = parseInt(e.attr("data-equal-phone"));
                                break;
                            default:
                                f = parseInt(e.attr("data-equal-desk"))
                        }
                        if (u = e.find(n.itemsClass),
                            u.length > 0)
                            if (u.height(""),
                                r = 0,
                                f) {
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                initRegularSlider: function () {
                    ...
                    n.selector.each(function () {
                        var t = $(this)
                            , i = t.parent().parent()
                            , r = void 0;
                        t.hasClass("hero__slider") ? r = t.closest(".hero__slider") : t.parent().hasClass("promoted-article__slider") ? r = t.closest(".promoted-article__container") : t.parent().hasClass("gallery__slider") && (r = t.closest(".gallery__container"));
                        t.on("init", function (t, r, u) {
                            var f = (u || 0) + 1;
                ...
                initReportSlider: function () {
                    ...
                    var n = $(".slick-slide").length
                        , t = $(".slider-sum")
                        , i = $(".slider-counter")
                        , r = $(".report");
                    n <= 1 && (t.hide(),
                        i.hide(),
                        r.addClass("hide-after"))
                }
            };
            t.default = i
        }
            ...
            var i = {
                init: function () {
                    var t = $("body")
                        , n = $("html, body")
                        , i = $(".header");
                    t.find(".hero").on("click", ".js-home-arrow-down", function () {
                        var r = $(".header").outerHeight()
                            , t = $(this).closest(".hero").next("div").offset().top;
                        i.hasClass("show") ? n.stop().animate({
                            scrollTop: t
                        }, 600) : n.stop().animate({
                            scrollTop: t - r - 10
                        }, 600)
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                bindVideoEvents: function () {
                    var n = this, t;
                    ($(document).on("click", n.playBtn, function () {
                        var t = $(this)
                            , i = t.closest(n.videoPopup).find(n.videoOverlay);
                        i.find(n.iframe).attr("src", t.data(n.videoUrl) + "?autoplay=1");
                        setTimeout(function () {
                            i.fadeIn(n.speed)
                        }, n.speed)
                    }),
                        this.$videoPopup.find(n.videoClsBtn).on("click", function () {
                            var t = $(this).closest(n.videoOverlay)
                                , i = t.find(n.iframe);
                            t.fadeOut(n.speed, function () {
                                i.attr("src", "")
                            })
                        }),
                        this.$win.width() > 1024) && (n.$doc.keydown(function (t) {
                            if (27 === t.keyCode) {
                                var i = n.$videoOverlay.find(n.iframe);
                                n.$videoOverlay.fadeOut(n.speed, function () {
                                    i.attr("src", "")
                                })
                            }
                        }),
                            t = null,
                            n.$videoWrap.hover(function () {
                                var i = $(this).find(n.video);
                                i.addClass(n.videoPlaying);
                                i.get(0).play();
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                mapLinkPopup: function () {
                    var n = $(".map__image").find(".map__dot");
                    ...
                    $(document).click(function (t) {
                        $(t.target).closest(".map__image").length || n.removeClass("active")
                    })
                },
                mapPosition: function () {
                    var n = $(".map__dot");
                    $(".map__image").find(n).each(function () {
                        var n = $(this)
                            , t = n.data("top")
                            , i = n.data("left");
                        n.css({
            ...
            var i = {
                init: function () {
                    var i = $("[data-tab]")
                        ...
                        , t = ""
                        , r = $(".tab__link");
                    n.length && (i.each(function () {
                        var n = $(this);
                        n.hasClass("selected") && (t = n.data("tab"))
                    }),
                        n.each(function () {
                            var n = $(this);
                            n.hasClass("js_" + t) && n.show()
                        }),
                        r.on("click", function () {
                            var t = $(this)
                                , i = t.data("tab")
                                , n = t.parents(".tabs__container");
                            n.find("[data-tab]").removeClass("selected");
                            t.addClass("selected");
                            n.find('[data-tab="' + i + '"]').addClass("selected");
                            n.find(".tab__content").hide();
                            n.find(".js_" + i).show()
                        }))
                }
            };
            ...
            var i = {
                ...
                peopleExpand: function () {
                    this.$person.on("click", function () {
                        var t = this, n = $(this), i, r;
                        if (n.closest(".people__item").hasClass("open"))
                            n.closest(".people__item").hasClass("open") && (n.next(".people__details").slideUp(300),
                                n.closest(".people__item").removeClass("open"));
                        else {
                            i = $(".people__details");
                            r = $(".people__item");
                            i.slideUp(300);
                            r.removeClass("open");
                            setTimeout(function () {
                                n.next(".people__details").slideDown(300)
                            }, 400);
                            n.closest(".people__item").addClass("open");
                            var u = $(".people__details")
                            ...
                            setTimeout(function () {
                                ...
                                var i, r;
                                f.length ? u && (i = $(t).closest(".people__widget").offset().top,
                                    n(e, i, o, s, 20)) : u && (r = $(t).closest(".people__widget").offset().top,
                                        n(e, r, o, 0, 10))
                            }, 300)
                        }
                    })
                },
                personPopupAutoOpen: function () {
                    var n = $(".people__item[selected]");
                    null != n && setTimeout(function () {
                        n.find("button").click()
                    }, 200)
                },
                checkPeopleItemPosition: function () {
                    this.$peopleList.each(function () {
                        var n = !1;
                        $(this).children().each(function () {
                            $(this).hasClass("people__description") ? n = !n : n && $(this).addClass("reversed")
                        })
                    })
                }
            };
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                resizeImages: function () {
                    this.$bgSwitch.length && this.$bgSwitch.each(function () {
                        var n = $(this)
                            , t = n.data("desktop-img")
                            , r = n.data("tablet-img")
                            , u = n.data("mobile-img")
                            , i = $(window).width();
                        i > 1024 ? "" !== n.data("desktop-img") && n.css("background-image", "url(" + t + ")") : i > 767 && $(window).width() < 1025 ? n.attr("data-tablet-img") ? n.css("background-image", "url(" + r + ")") : n.css("background-image", "url(" + t + ")") : n.attr("data-mobile-img") ? n.css("background-image", "url(" + u + ")") : n.css("background-image", "url(" + t + ")")
                    })
                }
            };
            t.default = i
        ...
        , function (n, t) {
            ...
            var i = {
                $yearTabList: $(".downloads__links"),
                $filter: $(".js-last_news-filter"),
                $articleWrapper: $(".articles"),
                guidEmpty: "00000000-0000-0000-0000-000000000000",
                init: function () {
                    this.clearFilters();
                    this.filterArticlesByType();
                    this.filterArticlesByYear();
                ...
                clearFilters: function () {
                    ...
                    $("#ListingCategories").prop("selectedIndex", 0).selectric("refresh");
                    $("#ListingRegions").prop("selectedIndex", 0).selectric("refresh")
                },
                filterArticlesByType: function () {
                    var n = this;
                    $("#ListingCategories").off("change").on("change", function () {
                        n.callAjax(1)
                    })
                },
                filterArticlesByYear: function () {
                    var n = this;
                    $("#ListingYears").off("change").on("change", function () {
                        n.callAjax(1)
                    })
                },
                filterArticlesByRegion: function () {
                    var n = this;
                    $("#ListingRegions").off("change").on("change", function () {
                        n.callAjax(1)
                    })
                },
                pagination: function () {
                    var n = this;
                    n.$articleWrapper.off("click", ".pagination__link").on("click", ".pagination__link", function () {
                        var i = $(this), t;
                        i.hasClass("pagination__link--disabled") || (t = i.data("page"),
                            n.callAjax(t),
                            setTimeout(function () {
                                n.$articleWrapper.find(".pagination__link--active").removeClass("pagination__link--active");
                                n.$articleWrapper.find("[pagination-number][data-page=" + t + "]").addClass("pagination__link--active")
                            }, 50))
                    })
                },
                callAjax: function (n) {
                    var t = this
                        , i = t.$articleWrapper.data("controller-url")
                        , r = t.$articleWrapper.data("page-key");
                    i && ($.get(i, {
                        pageKey: r,
                        year: function () {
                            var n = $("#ListingYears option:selected").val();
                            return void 0 !== n && 0 !== n.length || (n = 0),
                                n
                        }(),
                        typeKey: function () {
                            var n = $("#ListingCategories option:selected").val();
                            return void 0 !== n && 0 !== n.length || (n = t.guidEmpty),
                                n
                        }(),
                        regionKey: function () {
                            var n = $("#ListingRegions option:selected").val();
                            return void 0 !== n && 0 !== n.length || (n = t.guidEmpty),
                                n
                        }(),
                        page: n
                    }, function (n) {
                        t.$articleWrapper.empty();
                        t.$articleWrapper.append(n)
                    }, "html"),
                        history.pushState(null, null, window.location.pathname))
                },
                deleteUncessaryItems: function () {
                    var n = this;
                    $(document).ready(function () {
                        n.$filter.find(".selectric-scroll").find("li[data-index=0]").remove()
                    })
                }
            };
            t.default = i
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                mapPosition: function () {
                    var n = $(".map-locations__dot");
                    $(".map-locations__image").find(n).each(function () {
                        var n = $(this)
                            , t = n.data("top")
                            , i = n.data("left");
                        n.css({
                ...
                mapHover: function () {
                    var n = $(".map-locations__dot")
                        , t = $(".map-locations__item");
                    t.on("mouseover", function () {
                        var n = $(this).data("link");
                        $('.map-locations__dot[data-dot="' + n + '"]').addClass("active")
                    });
                    n.on("mouseover", function () {
                        var n = $(this).data("dot")
                            , t = $('.map-locations__item[data-link="' + n + '"]');
                        $(this).addClass("active");
                        t.css("text-decoration", "underline")
                    });
                    n.on("mouseleave", function () {
                        n.removeClass("active");
                        $(".map-locations__item").css("text-decoration", "none")
                    });
        ...
        , function (n, t) {
            ...
            var i = {
                $articleWrapper: $(".video-gallery__container"),
                init: function () {
                    this.pagination()
                },
                pagination: function () {
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                $search: $(".js-search-wildcards"),
                $wildcard: $(".js-wildcard"),
                $nav: $(".js-search-open"),
                $wildcardLink: $(".js-wildcard-link"),
                init: function () {
                    var n = this;
                    this.pagination();
                    this.focusoutWildcards();
                ...
                pagination: function () {
                    var n = this;
                    n.$searchWrapper.off("click", ".pagination__link").on("click", ".pagination__link", function () {
                        var i = $(this), t;
                        i.hasClass("pagination__link--disabled") || (t = i.data("page"),
                            n.callAjax(t),
                            setTimeout(function () {
                                n.$searchWrapper.find(".pagination__link--active").removeClass("pagination__link--active");
                                n.$searchWrapper.find("[pagination-number][data-page=" + t + "]").addClass("pagination__link--active")
                            }, 50))
                    })
                },
                callAjax: function (n) {
                    var t = this.$searchWrapper
                        , i = t.data("controller-url")
                        , r = t.data("page-key")
                        , u = t.data("query");
                    i && $.get(i, {
                        query: u,
                ...
                focusinWildcards: function () {
                    this.$wildcard.show()
                },
                focusoutWildcards: function () {
                    var n = this;
                    $("body").on("click", function (t) {
                        $(t.target).closest(".js-wildcard").length || $(t.target).closest(".search__input").length || $(t.target).closest(".js-search-wildcards").length || $(t.target).closest(".js-search-open").length || n.$wildcard.hide()
                    })
                }
            };
            t.default = i
                            ...
                            if (i) {
                                $.ajax({
                                    ...
                                    success: function (response) {
                                        ...
                                        n.$newsletterWrapper.addClass("newsletter__container--success");
                                        n.$newsletterWrapper.append('<span class="newsletter__success">' + response.message + "<\/span>");
                                    },
                                    error: function (xhr, status, error) {
                                        console.error('Subscription error:', error);
                                        n.$newsletterWrapper.append('<span class="newsletter__error">An error occurred. Please try again.<\/span>');
                                    }
                                });
                            }
                        }
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                pagination: function () {
                    var n = this;
                    n.$downloadsWrapper.off("click", ".pagination__link").on("click", ".pagination__link", function () {
                        var i = $(this), t;
                        i.hasClass("pagination__link--disabled") || (t = i.data("page"),
                            n.callAjax(t),
                            setTimeout(function () {
                                n.$downloadsWrapper.find(".pagination__link--active").removeClass("pagination__link--active");
                                n.$downloadsWrapper.find("[pagination-number][data-page=" + t + "]").addClass("pagination__link--active")
                            }, 50))
                    })
                },
                callAjax: function (n) {
                    var t = this
                        , i = t.$downloadsWrapper.data("controller-url")
                        , r = t.$downloadsWrapper.data("page-key");
                    i && $.get(i, {
                        pageKey: r,
                        year: function () {
                            var n = $("#Years option:selected").val();
                            return void 0 !== n && 0 !== n.length || (n = 0),
                                n
                        }(),
                        typeKey: function () {
                            var n = $("#Categories option:selected").val();
                            return void 0 !== n && 0 !== n.length || (n = t.guidEmpty),
                                n
                        }(),
                        page: n
                    }, function (n) {
                        t.$downloadsWrapper.empty();
                        t.$downloadsWrapper.append(n)
                    }, "html")
                }
            };
            t.default = i
        ...
        , function (n, t) {
            ...
            var i = {
                searchOverlayInputField: $(".search-overlay__input"),
                searchOverlayFormWrapper: $(".js-search-wrapper"),
                searchPageFormWrapper: $(".search-page__form-wrapper"),
                searchPageInputField: $(".search__input"),
                overlaySearchList: $(".search-overlay__wildcard-list-items"),
                pageSearchList: $(".search__wildcard-list-items"),
                homeSearchList: $(".hero__wildcard-list-items"),
                homeInput: $(".hero__input"),
                throttlingTime: 500,
                init: function () {
                    this.bindOverlaySearch();
                    this.bindSearchPageSearch();
                    this.bindHomePageSearch()
                },
                bindOverlaySearch: function () {
                    this.handleInputChange(this.searchOverlayInputField, void 0, this.overlaySearchList)
                },
                bindSearchPageSearch: function () {
                    this.handleInputChange(this.searchPageInputField, void 0, this.pageSearchList)
                },
                bindHomePageSearch: function () {
                    this.handleInputChange(this.homeInput, void 0, this.homeSearchList)
                },
                handleInputChange: function (n, t, i) {
                    var r = this
                        , u = r.searchOverlayFormWrapper.data("controller-url");
                    n.on("keyup", function () {
                        clearTimeout(t);
                        t = setTimeout(function () {
                            var t = n.val();
                            0 !== t.length ? r.callAjax(t, u, i) : i.html("")
                        }, r.throttlingTime)
                    })
                },
                callAjax: function (n, t, i) {
                    $.get(t, {
                        query: n
                    }, function (n) {
                        0 !== n.length ? (i.html(n),
        ...
        , function (n, t) {
            ...
            var i = {
                lists: document.querySelectorAll(".js-map-info-list"),
                classModifier: "map__info-list--columns",
                init: function () {
                    this.countItems()
                },
                countItems: function () {
                    var n = !0, r = !1, u = void 0, f, t, i;
                    try {
                        for (t = this.lists[Symbol.iterator](); !(n = (f = t.next()).done); n = !0)
                            i = f.value,
                                i.children.length > 5 && this.addModifierToList(i)
                    } catch (n) {
                        r = !0;
                        u = n
                    } finally {
                ...
                addModifierToList: function (n) {
                    n.classList.add(this.classModifier)
                }
            };
            t.default = i
        }
        , function (n, t) {
            ...
            var i = {
                $authorWrapper: $(".js-author-wrapper"),
                $filters: $(".js-filters"),
                ...
                moveElement: function () {
                    if ($(window).width() < 768) {
                        var t = $(".author__info")
                            , i = $(".author__link")
                            , n = this.$authorWrapper;
                        t.appendTo(n);
                        i.appendTo(n)
                    }
                },
                contactCard: function () {
                    $(window).width() < 768 && $(".contact-card__img-wrapper").appendTo(".contact-card__author")
                },
                paginationScroll: function () {
                    var u = $(".contact-card__container")
                        , r = u.height()
                        , n = $(".header").height()
                        , t = $("html, body")
                        , i = $(".search")
                        , f = $(".video-gallery");
                    $(document).on("click", ".pagination__link:not(.pagination__link--disabled)", function () {
                        ...
                        var o, s, h, c, l, a;
                        u.length ? i.length ? (o = $(this),
                            e(t, o.closest(i).find(".search__item:first-of-type").offset().top, n, r, -30)) : f.length ? (s = $(this),
                                e(t, s.closest(".video-gallery__container").offset().top, n, r, -10)) : (h = $(this),
                                    e(t, h.closest(".pagination").parent().offset().top, n, r, -30)) : i.length ? (c = $(this),
                                        e(t, c.closest(i).find(".search__item:first-of-type").offset().top, n, 0, 10)) : f.length ? (l = $(this),
                                            e(t, l.closest(".video-gallery__container").offset().top, n, 0, 30)) : (a = $(this),
                                                e(t, a.closest(".pagination").parent().offset().top, n, 0, 10))
                    })
                },
                newsletterMargin: function () {
                    var t = $(".newsletter")
                        , n = $(".newsletter__container")
                        , i = $(".full-image")
                        , r = $(".related-content")
                        , u = $(".error")
                        , f = n.height() / 2 + parseInt(n.css("padding-top")) - 4;
                    i.length || r.length || u.length || t.css("margin-top", f)
                },
                wrapTable: function () {
                ...
                scrollTop: function () {
                    ...
                    n.on("scroll", function () {
                        var i = $(this).scrollTop()
                            , t = $(".scroll-to-top");
                        n.width() >= 768 && (i < 100 ? t.fadeOut() : t.fadeIn())
                    });
                    t.on("click", function () {
                        i.animate({
                            scrollTop: 0
                ...
                searchMargin: function () {
                    var n = $(".search__item")
                        , t = $(".search__container");
                    n.length || t.css("margin-bottom", "140px")
                },
                filters: function () {
                    this.$filters.selectric()
                },
                clickableBox: function () {
                    var n = this.$clickable;
                    n.find("a").length ? n.on("click", function () {
                        var n = $(this);
                        window.location = n.find("a").attr("href")
                    }) : n.css("cursor", "default")
                },
                tableColspan: function () {
                    $("td[colspan]").css("width", "auto");
                    $("th[colspan]").css("width", "auto")
                },
                iframeheight: function () {
                    if ($(window).width() < 768) {
                        var n = $(".video-wrapper").data("mobile-height");
                        $("iframe").height(n)
                    }
                }
            };
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                stickyHeader: function () {
                    $(document).ready(function () {
                        var t = $(window), n = $(".header"), r = n.offset().top, u = $(".cookies").length, f = $(".urgent").length, i;
                        u || f || (i = $("body"),
                            n.addClass("header--sticky"),
                            t.width() < 992 ? i.css("padding-top", "70px") : i.css("padding-top", "134px"));
                        t.on("scroll", function () {
                            var u = t.scrollTop()
                                , i = $("body")
                                , f = n.scrollTop();
                            t.width() < 992 ? u + f >= r ? (n.addClass("header--sticky"),
                                i.css("padding-top", "70px")) : (n.removeClass("header--sticky"),
                                    i.css("padding-top", "0")) : u + f >= r ? (n.addClass("header--sticky"),
                                        i.css("padding-top", "134px")) : (n.removeClass("header--sticky"),
                                            i.css("padding-top", "0"))
                        })
                    })
                },
                stickyCard: function () {
                    $(document).ready(function () {
                        var t = $(window), n = $(".contact-card__container"), f = $(".header"), i = $(".contact-card__wrapper"), r, u;
                        n.length && (r = n.offset().top,
                            u = document.querySelectorAll(".contact-card--multi"),
                            u.length ? u.forEach(function (n, u) {
                                if (0 === u) {
                                    var e = n.querySelector(".contact-card__container")
                                        , o = n.querySelector(".contact-card__wrapper");
                                    t.on("scroll", function () {
                                        var u = t.scrollTop()
                                            , n = f.height()
                                            , s = n;
                                        u + n - parseInt(i.css("padding-top")) >= r ? (e.classList.remove("contact-card__container--shadow"),
                                            e.parentElement.classList.add("contact-card--sticky"),
                                            o.style.top = s + "px") : (e.classList.add("contact-card__container--shadow"),
                                                e.parentElement.classList.remove("contact-card--sticky"),
                                                o.style.top = 0)
                                    })
                                }
                            }) : t.on("scroll", function () {
                                var e = t.scrollTop()
                                    , u = f.height()
                                    , o = u;
                                e + u - parseInt(i.css("padding-top")) >= r ? (n.removeClass("contact-card__container--shadow"),
                                    n.parent().addClass("contact-card--sticky"),
                                    i.css("top", o)) : (n.addClass("contact-card__container--shadow"),
                                        n.parent().removeClass("contact-card--sticky"),
                                        i.css("top", 0))
                            }))
                    })
                }
        ...
        , function (n, t, i) {
            ...
            var u, r = (u = i(4)) && u.__esModule ? u : {
                "default": u
            }, f = {
                $urgentClose: $(".js-urgent-close"),
                $cookiesClose: $(".js-cookies-close"),
                $headerBtn: $(".js-dropdown-btn"),
                $headerDropdown: $(".js-header-dropdown"),
                $navSubmenu: $(".js-submenu"),
                $navLink: $(".js-nav-link"),
                ...
                bindClickEvents: function () {
                    function c() {
                        var r = $(window), t = $(".header"), e = t.offset().top, u, i, f, s;
                        ("none" === h.css("display") || "none" === o.css("display")) && (u = $("body"),
                            t.addClass("header--sticky"),
                            r.width() < 992 ? u.css("padding-top", "70px") : n.width() >= 992 && n.width() <= 1500 ? u.css("padding-top", "154px") : u.css("padding-top", "134px"));
                        r.on("scroll", function () {
                            var u = r.scrollTop()
                                , i = $("body")
                                , f = t.scrollTop();
                            r.width() < 992 ? u + f >= e ? (t.addClass("header--sticky"),
                                i.css("padding-top", "70px")) : (t.removeClass("header--sticky"),
                                    i.css("padding-top", "0")) : n.width() >= 992 && n.width() <= 1500 ? u + f >= e ? (t.addClass("header--sticky"),
                                        i.css("padding-top", "154px")) : (t.removeClass("header--sticky"),
                                            i.css("padding-top", "0")) : u + f >= e ? (t.addClass("header--sticky"),
                                                i.css("padding-top", "134px")) : (t.removeClass("header--sticky"),
                                                    i.css("padding-top", "0"))
                        });
                        if (i = $(".contact-card__container"),
                            f = $(".contact-card__wrapper"),
                            i.length) {
                            s = i.offset().top;
                            r.on("scroll", function () {
                                var u = r.scrollTop()
                                    , n = t.height()
                                    , e = n;
                                u + n - parseInt(f.css("padding-top")) >= s ? (i.removeClass("contact-card__container--shadow"),
                                    i.parent().addClass("contact-card--sticky"),
                                    f.css("top", e)) : (i.addClass("contact-card__container--shadow"),
                                        i.parent().removeClass("contact-card--sticky"),
                                        f.css("top", 0))
                            })
                        }
                    }
                    var v = this.$urgentClose, o = $(".urgent"), s = this.$cookiesClose, h = $(".cookies"), y = s.data("accept-cookie-url"), u, f, n;
                    v.on("click", function () {
                        o.stop().slideUp(300);
                        setTimeout(c, 300)
                    });
                    ...
                    u = this.$headerBtn;
                    f = this.$headerDropdown;
                    u.on("click", function () {
                        $(this).toggleClass("header__btn--active");
                        f.stop().slideToggle()
                    });
                    if (n = $(window),
                        n.width() >= 992 && $(document).on("click", function (n) {
                            u.is(n.target) || f.is(n.target) || $(".js-header-dropdown *").is(n.target) || (u.removeClass("header__btn--active"),
                                f.stop().slideUp())
                        }),
                        n.width() >= 992) {
                        var l = this.$navLink
                        ...
                        l.on("click", function () {
                            var u = $(this), f, e;
                            u.hasClass("nav__link--active") ? (u.removeClass("nav__link--active"),
                                u.siblings(t).stop().slideUp(),
                                n.width() >= 992 && (r.default.enableScroll(),
                                    $(".header--sticky").removeAttr("style"),
                                    n.height() < $(".nav__link--active").siblings(t).height() + i.height() && u.siblings(t).css({
                                        position: "absolute",
                                        top: "100%",
                                        height: "0"
                                    }),
                                    n.width() <= 1500 ? $("body").css("padding-top", "154px") : $("body").css("padding-top", "134px"))) : (u.addClass("nav__link--active"),
                                        u.closest(a).siblings().find(l).removeClass("nav__link--active"),
                                        u.closest(a).siblings().find(t).slideUp(),
                                        f = $(".urgent").length,
                                        e = $(".cookies").length,
                                        f && e ? "none" === $(".urgent").css("display") && "none" === $(".cookies").css("display") ? (u.siblings(t).stop().slideDown(),
                                            n.width() >= 992 ? (r.default.disableScroll(),
                                                setTimeout(function () {
                                                    n.height() < $(".nav__link--active").siblings(t).height() + i.height() && (n.width() <= 1500 ? u.siblings(t).css({
                                                        position: "fixed",
                                                        top: "154px",
                                                        overflow: "auto",
                                                ...
                                                }, 500)) : ($("body").css("overflow", "auto"),
                                                    $(".header--sticky").removeAttr("style"))) : setTimeout(function () {
                                                        u.siblings(t).stop().slideDown();
                                                        $("body").css("margin-top", "154px")
                                                    }, 500) : (u.siblings(t).stop().slideDown(),
                                                        n.width() >= 992 ? (r.default.disableScroll(),
                                                            setTimeout(function () {
                                                                n.height() < $(".nav__link--active").siblings(t).height() + i.height() && (n.width() <= 1500 ? u.siblings(t).css({
                                                                    position: "fixed",
                    ...
                    w.on("click", function () {
                        ...
                        e.find("input").focus();
                        n.width() < 992 && (k.removeClass("nav__toggle--open"),
                            d.stop().slideUp(200));
                        n.width() > 1024 && $(document).keydown(function (n) {
                            27 === n.keyCode && (e.fadeOut(300),
                                r.default.enableScroll())
                        })
                    });
                    b.on("click", function () {
                        e.fadeOut(300);
                        $(".search-overlay__input").val("");
                        $(".search-overlay__wildcard-list-items").html("");
                        r.default.enableScroll()
                    })
                },
                navigationFunction: function () {
                    var i = this.$navSubmenu, u = $(".nav__link"), f = this.navigation, e = $(window), v = $(document), t, o, s, h;
                    if (($(".nav__sub-block-title").length || ($(this).hide(),
                        $(this).parent().hide()),
                        e.width() < 992) && ($(".nav__submenu-title").parent().hide(),
                            t = this.navigation.find(".nav__item > .btn"),
                            t.addClass("nav__link js-nav-link"),
                            ...
                            o.on("click", function () {
                                var n = $(this)
                                    ...
                                    , t = $(".nav__submenu")
                                    , r = t.height();
                                i.find(".nav__list").addClass("nav__list--open");
                                n.closest(".nav__item").find(".nav__submenu").css("display", "block");
                                n.closest(".nav__item").siblings().find(".nav__submenu").css("display", "none");
                                n.closest(".nav__item").siblings().hide();
                                a < r + l && t.css({
                                    height: "100%",
                                    overflow: "auto"
                                })
                            ...
                            s.on("click", function () {
                                var n = $(this);
                                n.parents(".nav").find(".nav__list").removeClass("nav__list--open");
                                n.closest(".nav__submenu").css("display", "none");
                                n.closest(".nav__item").siblings().show()
                            })),
                        e.width() > 991) {
                        h = $("body");
                        v.on("click", function (n) {
                            $("#downloadForm").length || u.is(n.target) || i.is(n.target) || $(".nav__submenu *").is(n.target) || $(".search-overlay").is(n.target) || $(".search-overlay *").is(n.target) || (i.stop().slideUp(400),
                                u.removeClass("nav__link--active"),
                                h.removeClass("scroll-disabled"),
                                r.default.isScrollDisabled = !1)
                        })
                    }
                    var y = this.navToggle
                        , n = $(".nav__list")
                        , p = $("html, body")
                        , c = $(".header")
                        , l = c.height()
                    ...
                    y.on("click", function () {
                        ...
                        u = $(".urgent").length;
                        f = $(".cookies").length;
                        t.hasClass("nav__toggle--open") ? (t.removeClass("nav__toggle--open"),
                            n.stop().slideUp(200),
                            r.default.enableScroll()) : (t.addClass("nav__toggle--open"),
            ...
            var i = {
                ...
                accordions: function () {
                    ...
                    var i = this.accordion
                        , r = this.accordion.find(".accordion__button")
                        , n = this.accordion.find(".accordion__content");
                    i.each(function () {
                        $(this).find(r).on("click", function () {
                            var u = $(this)
                                , o = $(".contact-card__container")
                                , f = $(".header").height()
                                , s = o.height()
                                , e = $("html, body");
                            u.find(".accordion__button-circle").hasClass("accordion__button-circle--opened") ? (u.find(".accordion__button-circle").removeClass("accordion__button-circle--opened"),
                                u.css("color", "#1a191b"),
                                u.next(n).stop().slideUp(400, function () {
                                    $(this).attr("aria-hidden", "true");
                                    o.length ? t(e, u.offset().top, f, s, 10) : t(e, u.offset().top, f, 0, 10)
                                }),
                                u.next(n).find("iframe").vimeo("pause")) : (u.parent().siblings().find(".accordion__button-circle--opened").removeClass("accordion__button-circle--opened"),
                                    u.css("color", "#2a61ff"),
                                    u.parent().siblings().find(r).css("color", "#1a191b"),
                                    u.parent().siblings().find(n).stop().slideUp(400, function () {
                                        $(this).attr("aria-hidden", "true")
                                    }),
                                    u.closest(i).siblings().find(".accordion__button-circle--opened").removeClass("accordion__button-circle--opened"),
                                    u.closest(i).siblings().find(n).stop().slideUp(400, function () {
                                        $(this).attr("aria-hidden", "true")
                                    }),
                                    u.find(".accordion__button-circle").addClass("accordion__button-circle--opened"),
                                    u.next(n).stop().slideDown(400, function () {
                                        $(this).removeAttr("aria-hidden");
                                        o.length ? t(e, u.offset().top, f, s, 10) : t(e, u.offset().top, f, 0, 10)
                                    }),
                                    u.parent().siblings().find("iframe").vimeo("pause"),
                                    setTimeout(function () {
                                        u.parent().find(".js-slider").length && u.parent().find(".js-slider").slick("setPosition")
                                    }, 10))
                        })
                    })
                }
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                showPopup: function () {
                    this.$popupBtn.on("click", function (n) {
                        var i, t, r;
                        n.preventDefault();
                        n.stopPropagation();
                        i = $(this).find("a").data("anchor");
                        t = $(i).closest("p");
                        void 0 !== $(t).offset() && (r = '<div class="popup"><div class="popup-text">' + $(t).text() + "<\/div><\/div>",
                            $(this).find(".popup").length > 0 ? $(".js-popup").find(".popup").remove() : $(this).append(r))
                    })
                },
                hidePopup: function () {
                    $("body").on("click", function () {
                        $(".js-popup").find(".popup").remove()
                    })
                }
            };
            t.default = i
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                points: document.querySelectorAll(".js-map-point"),
                infoConts: document.querySelectorAll(".js-map-info-cont"),
                closeButtons: document.querySelectorAll(".js-map-info-close"),
                list: document.querySelector(".js-map-list"),
                listControls: document.querySelectorAll(".js-map-control"),
                nameListItems: document.querySelectorAll(".js-map-list-item"),
                mapWrap: document.querySelector(".js-map-wrap"),
                tabletView: !1,
                tabletBreakpoint: 992,
                isInfoContOpen: !1,
                classInfoCont: ".js-map-info-cont",
                classInfoContActive: "map__info-cont--active",
                classInfoCloseBtn: ".js-map-info-close",
                classPointFocus: "map__point--focus",
                classPointHide: "map__point--hide",
                classMapCont: ".js-map-cont",
                classMapContent: ".js-map-content",
                classMapWrap: ".js-map-wrap",
                classListItem: "js-map-list-item",
                classListControl: "js-map-control",
                init: function () {
                    this.map && (this.settingStyles(),
                        this.bindClickEvent(),
                        this.bindHoverEvent(),
                        this.tabletViewChange(),
                        this.windowListener(),
                        this.mapListener())
                },
                settingStyles: function () {
                    var t = !0, r = !1, u = void 0, f, i;
                    try {
                        for (i = this.points[Symbol.iterator](); !(t = (f = i.next()).done); t = !0) {
                            var n = f.value
                                , e = n.getAttribute("data-y-align")
                                , o = n.getAttribute("data-x-align");
                ...
                bindClickEvent: function () {
                    var n = this, f = !0, h = !1, c = void 0, l, t, y, i, b, r, g, u;
                    try {
                        for (t = this.points[Symbol.iterator](); !(f = (l = t.next()).done); f = !0)
                            l.value.addEventListener("click", function (t) {
                                n.openInfoCont(t)
                            })
                    } catch (n) {
                        h = !0;
                    ...
                    var e = !0
                        ...
                        , v = void 0;
                    try {
                        for (i = this.closeButtons[Symbol.iterator](); !(e = (y = i.next()).done); e = !0)
                            y.value.addEventListener("click", function (t) {
                                n.closeInfoCont(t)
                            })
                    } catch (n) {
                        a = !0;
                    ...
                    var nt = function (t) {
                        t.addEventListener("click", function (i) {
                            var r = i.target;
                            i.target !== t && (r = i.target.closest("." + n.classListControl));
                            n.scrollList(r)
                        })
                    }
                        , o = !0
                        ...
                        , w = void 0;
                    try {
                        for (r = this.listControls[Symbol.iterator](); !(o = (b = r.next()).done); o = !0)
                            nt(b.value)
                    } catch (n) {
                        p = !0;
                        w = n
                    ...
                    var tt = function (t) {
                        t.addEventListener("click", function (i) {
                            var r = i.target;
                            i.target !== t && (r = i.target.closest("." + n.classListItem));
                            n.openInfoCont(r)
                        }, !1)
                    }
                        , s = !0
                        ...
                        , d = void 0;
                    try {
                        for (u = this.nameListItems[Symbol.iterator](); !(s = (g = u.next()).done); s = !0)
                            tt(g.value)
                    } catch (n) {
                        k = !0;
                        d = n
                ...
                bindHoverEvent: function () {
                    var t = this, i = !0, u = !1, f = void 0, e, n, r;
                    try {
                        for (n = this.nameListItems[Symbol.iterator](); !(i = (e = n.next()).done); i = !0)
                            r = e.value,
                ...
                windowListener: function () {
                    ...
                    window.addEventListener("resize", function () {
                        !1 === n.tabletView && window.innerWidth < n.tabletBreakpoint ? n.tabletViewChange() : !0 === n.tabletView && window.innerWidth > n.tabletBreakpoint - 1 && n.tabletViewChange()
                    })
                },
                mapListener: function () {
                    var n = this;
                    this.map.addEventListener("click", function (t) {
                        n.handleBodyClick(t)
                    })
                },
                handleBodyClick: function (n) {
                    !this.isInfoContOpen || void 0 === n || n.target.getAttribute("data-id") || n.target.closest("." + this.classListItem) || n.target.closest(".js-map-info-cont") || this.closeInfoCont(!1)
                },
                openInfoCont: function (n) {
                    var e, h, t, i, a, r;
                    e = !0 === n.isTrusted ? n.target.getAttribute("data-id") : n.getAttribute("data-id");
                    var u = !0
                        , o = !1
                        , s = void 0;
                    try {
                        for (t = this.infoConts[Symbol.iterator](); !(u = (h = t.next()).done); u = !0)
                            i = h.value,
                                i.getAttribute("data-id") === e ? i.classList.add(this.classInfoContActive) : i.classList.remove(this.classInfoContActive)
                    } catch (n) {
                        o = !0;
                        s = n
                    } finally {
                    ...
                    this.isInfoContOpen = !0;
                    var f = !0
                        , c = !1
                        , l = void 0;
                    try {
                        for (r = this.points[Symbol.iterator](); !(f = (a = r.next()).done); f = !0)
                            a.value.classList.add(this.classPointHide)
                    } catch (n) {
                        c = !0;
                        l = n
                    } finally {
                ...
                closeInfoCont: function (n) {
                    var h, t, a, i, p, r;
                    if (n) {
                        n.target.closest(this.classInfoCont).classList.remove(this.classInfoContActive);
                        this.isInfoContOpen = !1;
                        var u = !0
                            , o = !1
                            , s = void 0;
                        try {
                            for (t = this.points[Symbol.iterator](); !(u = (h = t.next()).done); u = !0)
                                h.value.classList.remove(this.classPointHide)
                        } catch (n) {
                            o = !0;
                            s = n
                        } finally {
                        ...
                        var f = !0
                            ...
                            , l = void 0;
                        try {
                            for (i = this.infoConts[Symbol.iterator](); !(f = (a = i.next()).done); f = !0)
                                a.value.classList.remove(this.classInfoContActive)
                        } catch (n) {
                            c = !0;
                            l = n
                        } finally {
                        ...
                        var e = !0
                            ...
                            , y = void 0;
                        try {
                            for (r = this.points[Symbol.iterator](); !(e = (p = r.next()).done); e = !0)
                                p.value.classList.remove(this.classPointHide)
                        } catch (n) {
                            v = !0;
                            y = n
                        } finally {
                ...
                hoverPointName: function (n) {
                    var o = n.target.getAttribute("data-id"), r = !0, u = !1, f = void 0, e, t, i;
                    try {
                        for (t = this.points[Symbol.iterator](); !(r = (e = t.next()).done); r = !0)
                            i = e.value,
                                i.getAttribute("data-id") === o ? i.classList.add(this.classPointFocus) : i.classList.add(this.classPointHide)
                    } catch (n) {
                        u = !0;
                        f = n
                    } finally {
                ...
                mouseLeaveItems: function () {
                    var o, t, c, i, u;
                    if (this.isInfoContOpen) {
                        var n = !0
                            , f = !1
                            , e = void 0;
                        try {
                            for (t = this.points[Symbol.iterator](); !(n = (o = t.next()).done); n = !0)
                                o.value.classList.remove(this.classPointFocus)
                        } catch (n) {
                            f = !0;
                            e = n
                        } finally {
                        ...
                        var r = !0
                            ...
                            , h = void 0;
                        try {
                            for (i = this.points[Symbol.iterator](); !(r = (c = i.next()).done); r = !0)
                                u = c.value,
                                    u.classList.remove(this.classPointFocus),
                                    u.classList.remove(this.classPointHide)
                        } catch (n) {
                            s = !0;
                            h = n
                        } finally {
                ...
                scrollList: function (n) {
                    ...
                    if (window.innerWidth < this.tabletBreakpoint)
                        ...
                        this.list.scrollTop = this.list.scrollTop - 305;
                    else {
                        if ("down" !== t)
                            return;
                        this.list.scrollTop = this.list.scrollTop + 305
                ...
                tabletViewChange: function () {
                    window.innerWidth < this.tabletBreakpoint ? ($(this.classMapCont).detach().appendTo(this.classMapContent),
                        this.tabletView = !0) : ($(this.classMapCont).detach().appendTo(this.classMapWrap),
                            this.tabletView = !1)
                }
            };
            t.default = i
        ...
        , function (n, t) {
            ...
            var i = {
                ...
                iframeWrapperClass: ".js-iframe-wrapper",
                iframeClass: ".js-video-iframe",
                iframeExpandClass: "js-iframe-expand",
                popupClass: ".js-iframe-popup",
                popupIframeClass: ".js-popup-iframe",
                playBtnClass: ".js-iframe-play",
                closeBtnClass: ".js-popup-close",
                popupShowClass: "video-wrapper__popup--show",
                windowWidth: $(window).width(),
                init: function () {
                    this.iframeWrapper.length && (this.handleIframes(),
                        this.addPlayBtnsClickEvent(),
                        this.addCloseBtnsClickEvent())
                },
                handleIframes: function () {
                    var n = this;
                    this.iframeWrapper.each(function (t, i) {
                        var r = $(i)
                            , u = r.find(n.iframeClass);
                        r.hasClass(n.iframeExpandClass) && n.setIframeFullWidth(u);
                        n.createIntersectionObserver(u)
                    })
                },
                addPlayBtnsClickEvent: function () {
                    var n = this;
                    $(document).on("click", this.playBtnClass, function (t) {
                        var r = $(t.currentTarget)
                            , i = n.findElements(r)
                            , u = i.$popupIframe;
                        i.$popup.addClass(n.popupShowClass);
                        n.startAutoplay(u)
                    })
                },
                addCloseBtnsClickEvent: function () {
                    var n = this;
                    $(document).on("click", this.closeBtnClass, function (t) {
                        var r = $(t.currentTarget)
                            , i = n.findElements(r)
                            , u = i.$popupIframe
                            , f = i.$popup;
                        n.stopAutoplay(u);
                        f.removeClass(n.popupShowClass)
                    })
                },
                findElements: function (n) {
                    var t = n.closest(this.iframeWrapperClass)
                        , r = t.find(this.iframeClass)
                        , i = t.find(this.popupClass);
                    return {
                        $iframe: r,
                        $popupIframe: i.find(this.popupIframeClass),
                        $popup: i
                    }
                },
                startAutoplay: function (n) {
                    var t = n.attr("src") + "&autoplay=1&muted=1&autopause=0";
                    n.attr("src", t)
                },
                stopAutoplay: function (n) {
                    var t = n.attr("src").replace(/(&?autoplay=1|&?muted=1|&?autopause=0)/g, "");
                    n.attr("src", t)
                },
                setIframeFullWidth: function (n) {
                    var t = n[0].getBoundingClientRect().left;
                    n.css({
                        width: this.windowWidth + "px",
                        "margin-left": "-" + Math.ceil(t) + "px",
                        height: 9 * this.windowWidth / 16 + "px"
                    })
                },
                createIntersectionObserver: function (n) {
                    var i = this
                        , t = new IntersectionObserver(function (r) {
                            r.forEach(function (r) {
                                r.isIntersecting && (i.startAutoplay(n),
                                    t.unobserve(n[0]))
                            })
                        }
                            , {
