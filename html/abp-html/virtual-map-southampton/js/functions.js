...
$(document).ready(function() {
  ...
  //$('#splash-container').load('./inline/splash/splash-intro.html');
  //$('#splash-container').delay(0).css("display", "flex").hide().fadeIn();
  //$('.splash').delay(2000).css("display", "flex").hide().fadeIn();
  ...
  /*$("#splash-container").hide(); 
    setTimeout(function(){ 
       $('#splash-container').load('./inline/splash/splash-intro.html');
       $('#splash-container').css("display", "flex").hide().fadeIn();
    },30000); */
...
$('body').on('click', 'a.toggle-link-video', function() {
    var myLink = $(this).attr('data-link');
    $('.lightbox-container').load('./inline/info/' + myLink );
    $(".sidebar").removeClass('open');
    $(".sidebar").hide();
