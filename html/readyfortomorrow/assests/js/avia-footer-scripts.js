...
(function (e) {
  ...
  e(window).on("av-height-change", function (e) {
    const event = new CustomEvent("avia_height_change", opt);
    window.dispatchEvent(event);
  });
  e("body").on("av_resize_finished", function (e) {
...
(function (e) {
  ...
  e(function () {
    ...
    new e.AviaAjaxSearch({
      scope: "#header, .avia_search_element",
    });
    if (e.fn.avia_iso_sort) {
      e(".grid-sort-container").avia_iso_sort();
    }
    a();
    e.avia_utilities.avia_ajax_call();
    e.avia_utilities.postSwipeSupport();
  });
  e.avia_utilities = e.avia_utilities || {};
  e.avia_utilities.postSwipeSupport = function () {
    if (!e.fn.avia_swipe_trigger) {
      return;
    }
    const body = document.getElementsByTagName("body"),
      methods = {};
    methods.beforeTrigger = function (t, i) {
      const loader = e.avia_utilities.loading();
      loader.show();
    };
    methods.afterTrigger = function (e, t) {
      let body = document.getElementsByTagName("body");
      if (!body.length) {
        return;
      }
      let dir = t == "prev" ? "swiped-ltr" : "swiped-rtl";
      body[0].classList.add("av-post-swiped-overlay", dir);
    };
    if (
      !body.length ||
      !body[0].classList.contains("avia-post-nav-swipe-enabled")
    ) {
      return;
    }
    ...
    let prev = document.querySelector(
        "#wrap_all .avia-post-nav.avia-post-prev",
      ),
    ...
    e(single).avia_swipe_trigger(param);
  };
  e.avia_utilities.avia_ajax_call = function (t) {
    if (typeof t == "undefined") {
      t = "body";
    }
    e("a.avianolink").on("click", function (e) {
      e.preventDefault();
    });
    e("a.aviablank").attr("target", "_blank");
    if (e.fn.avia_activate_lightbox) {
      e(t).avia_activate_lightbox();
    }
    if (e.fn.avia_scrollspy) {
      if (t == "body") {
        e("body").avia_scrollspy({
          target: ".main_menu .menu li > a",
        });
      } else {
        e("body").avia_scrollspy("refresh");
      }
    }
    if (e.fn.avia_smoothscroll) {
      e('a[href*="#"]', t).avia_smoothscroll(t);
    }
    l(t);
    n(t);
    r(t);
    if (e.fn.avia_html5_activation && e.fn.mediaelementplayer) {
      e(".avia_video, .avia_audio", t).avia_html5_activation({
        ratio: "16:9",
      });
    }
  };
  e.avia_utilities.log = function (e, t, i) {
  ...
  function i() {
    var n = e(window),
      i = e("html").is(".html_header_sidebar") ? "#main" : "#header",
      a = e(i),
      r = a.parents("div").eq(0),
      l = e(i + " .container").first(),
      t = "",
      o = function () {
        var i = "",
          o = Math.round(l.width()),
          s = Math.round(a.width()),
          n = Math.round(r.width());
        i += " #header .three.units{width:" + o * 0.25 + "px;}";
        i += " #header .six.units{width:" + o * 0.5 + "px;}";
        i += " #header .nine.units{width:" + o * 0.75 + "px;}";
        i += " #header .twelve.units{width:" + o + "px;}";
        i +=
          " .av-framed-box .av-layout-tab-inner .container{width:" + n + "px;}";
        i +=
          " .html_header_sidebar .av-layout-tab-inner .container{width:" +
          s +
          "px;}";
        i += " .boxed .av-layout-tab-inner .container{width:" + s + "px;}";
        i += " .av-framed-box#top .av-submenu-container{width:" + n + "px;}";
        try {
          t.text(i);
        } catch (p) {
          t.remove();
    ...
    if (
      e(".avia_mega_div").length > 0 ||
      e(".av-layout-tab-inner").length > 0 ||
      e(".av-submenu-container").length > 0
    ) {
      var s = e("head").first();
      t = e(
  ...
  function a() {
    var t = e(".sidebar_shadow#top #main .sidebar"),
      i = e(".sidebar_shadow .content");
    if (t.height() >= i.height()) {
      t.addClass("av-enable-shadow");
    } else {
  ...
  function t(t, a) {
    ...
    i.$body = e("body");
    i.$win = e(window);
    i.options = e.extend({}, e.fn.avia_scrollspy.defaults, a);
    i.selector =
      i.options.target ||
    ...
    if (i.$body.find(i.selector + "[href*='#']").length) {
      i.$scrollElement = r.on("scroll.scroll-spy.data-api", n);
  ...
  t.prototype = {
      ...
      i = this.$body
        ...
        .map(function () {
          var s = e(this),
            ...
            i = i.replace(/\//g, ""),
            a = /^#\w/.test(i) && e(i),
            o = t.$scrollElement.get(0),
            r = o != null && o === o.window;
          return (
            (a &&
              a.length && [
                [a.position().top + (!r && t.$scrollElement.scrollTop()), n],
              ]) ||
            null
          );
        })
    ...
    process: function () {
      ...
      var i = this.$scrollElement.scrollTop() + this.options.offset,
        s = this.$scrollElement[0].scrollHeight || this.$body[0].scrollHeight,
        n = s - this.$scrollElement.height(),
        t = this.offsets,
        a = this.targets,
        o = this.activeTarget,
        e;
      if (i >= n) {
        return o != (e = a.last()[0]) && this.activate(e);
      }
      for (e = t.length; e--; ) {
        o != a[e] &&
          i >= t[e] &&
    ...
    activate: function (t) {
      ...
      a =
        ...
        t +
        '"]';
      i = e(a).parent("li").addClass(this.options.applyClass);
  ...
  e.fn.avia_scrollspy = function (i) {
    return this.each(function () {
      var o = e(this),
        a = o.data("scrollspy"),
        s = typeof i == "object" && i;
      if (!a) o.data("scrollspy", (a = new t(this, s)));
      if (typeof i == "string") a[i]();
    });
  };
  e.fn.avia_scrollspy.Constructor = t;
  e.fn.avia_scrollspy.calc_offset = function () {
    var t =
        parseInt(e(".html_header_sticky #main").data("scroll-offset"), 10) || 0,
      i =
        e(
      ...
      o = 1,
      s = parseInt(e("html").css("margin-top"), 10) || 0,
      n = parseInt(e(".av-frame-top ").outerHeight(), 10) || 0;
    return t + i + a + o + s + n;
  };
  e.fn.avia_scrollspy.defaults = {
    offset: e.fn.avia_scrollspy.calc_offset(),
  ...
  function o(t) {
    ...
    if (typeof i !== "undefined") {
      var a = "",
        s = i.version ? parseInt(i.version) : "";
      ...
      if (i.version) a += " " + a + "-" + s + " ";
      if (i.browser)
        a += " avia-" + i.browser + " avia-" + i.browser + "-" + s + " ";
    }
    if (t) {
      e(t).addClass(a);
    }
  ...
  function s(t) {
    var i = [];
    e.avia_utilities.isTouchDevice =
      "ontouchstart" in window ||
      (window.DocumentTouch && document instanceof window.DocumentTouch) ||
      navigator.maxTouchPoints > 0 ||
      window.navigator.msMaxTouchPoints > 0;
    i.push(e.avia_utilities.isTouchDevice ? "touch-device" : "no-touch-device");
    e.avia_utilities.pointerDevices = [];
    if (typeof window.matchMedia != "function") {
      e.avia_utilities.pointerDevices.push("undefined");
      i.push("pointer-device-undefined");
    } else {
      var a = !1;
      if (window.matchMedia("(any-pointer: fine)")) {
        i.push("pointer-device-fine");
        e.avia_utilities.pointerDevices.push("fine");
        a = !0;
      }
      if (window.matchMedia("(any-pointer: coarse)")) {
        i.push("pointer-device-coarse");
        e.avia_utilities.pointerDevices.push("coarse");
        if (!a) {
          i.push("pointer-device-coarse-only");
        }
      }
      if (!e.avia_utilities.pointerDevices.length) {
        i.push("pointer-device-none");
        e.avia_utilities.pointerDevices.push("none");
      }
    }
  ...
  e.fn.avia_html5_activation = function (t) {
    var i = {
      ratio: "16:9",
    };
    var t = e.extend(i, t);
    this.each(function () {
      var t = e(this),
        ...
        a = t.closest(".avia-video");
      if (a.length > 0 && a.hasClass("av-html5-fullscreen-btn")) {
        i.push("fullscreen");
      }
      if (!e(this).prop("controls")) {
        i = [];
      }
      t.mediaelementplayer({
        ...
        success: function (i, a, o) {
          e.AviaVideoAPI.players[t.attr("id").replace(/_html5/, "")] = o;
          setTimeout(function () {
            if (i.pluginType == "flash") {
              i.addEventListener(
                "canplay",
                function () {
                  t.trigger("av-mediajs-loaded");
                },
                !1,
              );
            } else {
              t.trigger("av-mediajs-loaded").addClass("av-mediajs-loaded");
            }
            i.addEventListener(
              "ended",
              function () {
                t.trigger("av-mediajs-ended");
              },
              !1,
            );
            var a = document.getElementById(e(i).attr("id") + "_html5");
            if (a && a !== i) {
              i.addEventListener("ended", function () {
                e(a).trigger("av-mediajs-ended");
              });
            }
          }, 10);
        },
  ...
  function n(t) {
    ...
    if (e("body").hasClass("av-disable-avia-hover-effect")) {
      return;
    }
    var o = "",
      a = e.avia_utilities.supports("transition"),
      i = [];
    if (t == "body") {
      i = e("#main a img")
        .parents("a")
    ...
    i.each(function (t) {
      var o = e(this),
        r = o.find("img").first();
      if (r.hasClass("alignleft")) {
        o.addClass("alignleft").css({
          float: "left",
          margin: 0,
          padding: 0,
        });
      }
      if (r.hasClass("alignright")) {
        o.addClass("alignright").css({
          float: "right",
          margin: 0,
          padding: 0,
        });
      }
      if (r.hasClass("aligncenter")) {
        o.addClass("aligncenter").css({
          float: "none",
          "text-align": "center",
          margin: 0,
          padding: 0,
      ...
      var l = o.attr("href"),
        s = "overlay-type-video",
        p = o.data("opacity") || 0.7,
        c = 5,
        n = o.find(".image-overlay");
      if (l) {
        if (l.match(/(jpg|gif|jpeg|png|tif)/)) {
          s = "overlay-type-image";
        }
        if (
          !l.match(
  ...
  (function (e) {
    e.fn.avia_smoothscroll = function (t) {
      if (!this.length) {
        return;
      }
      var a = e(window),
        h = e("#header"),
        f = e(".html_header_top.html_header_sticky #main").not(
          ".page-template-template-blank-php #main",
        ),
        u = e(".html_header_top.html_header_unstick_top_disabled #header_meta"),
        v = e(
          ".html_header_top:not(.html_top_nav_header) #header_main_alternate",
        ),
        m = e(".html_header_top.html_top_nav_header"),
        l = e(".html_header_top.html_header_shrinking").length,
        c = e(".av-frame-top"),
        i = 0,
        p = e.avia_utilities.isMobile,
        o = e(".sticky_placeholder").first(),
        d = function () {
          if (h.css("position") == "fixed") {
            var t = parseInt(f.data("scroll-offset"), 10) || 0,
            ...
            t += parseInt(e("html").css("margin-top"), 10);
            i = t;
          } else {
            i = parseInt(e("html").css("margin-top"), 10);
          }
          if (c.length) {
            i += c.height();
          }
          if (m.length) {
            i =
              e(".html_header_sticky #header_main_alternate").height() +
              parseInt(e("html").css("margin-top"), 10);
          }
          if (p) {
            i = 0;
          }
      ...
      d();
      a.on("debouncedresize av-height-change", d);
      var s = window.location.hash.replace(/\//g, "");
      if (
        i > 0 &&
        s &&
        t == "body" &&
        ...
        if (n.length) {
          a.on("scroll.avia_first_scroll", function () {
            setTimeout(function () {
              if (o.length && n.offset().top > o.offset().top) {
                r = o.outerHeight() - 3;
              }
              a.off("scroll.avia_first_scroll").scrollTop(
                n.offset().top - i - r,
              );
            }, 10);
          });
      ...
      return this.each(function () {
        e(this).on("click", function (t) {
          var n = this.hash.replace(/\//g, ""),
            ...
            u = !1,
            b =
              "undefined" != typeof r.no_scroll_in_viewport &&
              r.no_scroll_in_viewport == 1,
            T = "undefined" != typeof r.ignore_hash && r.ignore_hash == 1;
          if (
            n != "" &&
            n != "#" &&
            n != "#prev" &&
            n != "#next" &&
            !p.is(".comment-reply-link, #cancel-comment-reply-link, .no-scroll")
          ) {
            var s = "",
              f = "";
            if ("#next-section" == n) {
            ...
            if (s.length && !u) {
              var d = a.scrollTop(),
                ...
                c = c.replace(/\//g, ""),
                v = window.location.href.replace(c, ""),
                m = this,
                g = r.duration || 1200,
                y = r.easing || "easeInOutQuint";
              if (o.length && h > o.offset().top) {
                l -= o.outerHeight() - 3;
              }
              if (
                "undefined" != typeof r.scroll_top_offset &&
                Number.isInteger(r.scroll_top_offset)
              ) {
                l -= r.scroll_top_offset;
              }
              if (v + n == m || f) {
                if (d != l) {
                  if (!(d == 0 && l <= 0)) {
                    ...
                    e("html:not(:animated),body:not(:animated)").animate(
                      ...
                      y,
                      function () {
                        a.trigger("avia_smooth_scroll_end");
                        if (!T) {
  ...
  function r(e) {
    var t = jQuery('iframe[src*="youtube.com"]:not(.av_youtube_frame)', e),
      i = jQuery(
  ...
  function c() {
    var i = e(window),
      ...
      a = function () {
        var e = i.scrollTop();
        if (e < 500) {
          t.removeClass("avia_pop_class");
        } else if (!t.is(".avia_pop_class")) {
          t.addClass("avia_pop_class");
        }
      };
  ...
  e.AviaAjaxSearch = function (t) {
    var i = {
      delay: 300,
      minChars: 3,
      scope: "body",
    };
    this.options = e.extend({}, i, t);
    this.scope = e(this.options.scope);
    this.timer = !1;
    this.lastVal = "";
    this.bind_events();
  };
  e.AviaAjaxSearch.prototype = {
    ...
    try_search: function (t) {
      var i = e(t.currentTarget).parents("form").eq(0),
        a = i.find(".ajax_search_response");
      ...
      if (
        t.currentTarget.value.length >= this.options.minChars &&
        this.lastVal != t.currentTarget.value.trim()
      ) {
        this.timer = setTimeout(
          this.do_search.bind(this, t),
          this.options.delay,
        );
      } else if (t.currentTarget.value.length == 0) {
        this.timer = setTimeout(this.reset.bind(this, t), this.options.delay);
      }
    },
    reset: function (t) {
      var i = e(t.currentTarget).parents("form").eq(0),
        a = i.find(".ajax_search_response"),
        o = e(i.attr("data-ajaxcontainer")).find(".ajax_search_response"),
        s = e(t.currentTarget);
      if (e(t.currentTarget).hasClass("av-results-parked")) {
        a.show();
        o.show();
        e("body > .ajax_search_response").show();
      } else {
        a.remove();
        o.remove();
        s.val("");
        e("body > .ajax_search_response").remove();
      }
    },
    do_search: function (t) {
      var w = this,
        l = e(t.currentTarget).attr("autocomplete", "off"),
        c = e(t.currentTarget).parents(".av_searchform_wrapper").eq(0),
        d = c.offset(),
        m = c.outerWidth(),
        g = c.outerHeight(),
        i = l.parents("form").eq(0),
        y = i.find("#searchsubmit"),
        s = i,
        a = s.find(".ajax_search_response"),
        h = e(
      ...
      p += "&action=avia_ajax_search";
      if (!a.length) {
        a = e('<div class="ajax_search_response" style="display:none;"></div>');
      }
      ...
      if (i.attr("id") == "searchform_element") {
        a.addClass("av_searchform_element_results");
      }
      if (n.indexOf("?") != -1) {
        n = n.split("?");
        p += "&" + n[1];
      ...
      if (i.attr("data-ajaxcontainer")) {
        ...
        if (e(r).length) {
          e(r).find(".ajax_search_response").remove();
          s = e(r);
        }
      }
      o = {};
      if (i.hasClass("av_results_container_fixed")) {
        e("body").find(".ajax_search_response").remove();
        s = e("body");
        var o = {
          top: d.top + g,
          left: d.left,
      ...
      a.css(o);
      if (s.hasClass("avia-section")) {
        a.addClass("container");
      }
      a.appendTo(s);
      if (
        a.find(".ajax_not_found").length &&
        t.currentTarget.value.indexOf(this.lastVal) != -1
      ) {
        return;
      }
      this.lastVal = t.currentTarget.value;
      e.ajax({
      ...
      e(document).on("click", function (t) {
        if (!e(t.target).closest(i).length) {
          if (e(a).is(":visible")) {
            e(a).hide();
  ...
  e.AviaTooltip = function (t) {
    ...
    this.inner = e('<div class="inner_tooltip"></div>').prependTo(this.tooltip);
    this.open = !1;
    this.timer = !1;
    this.active = !1;
    this.bind_events();
  };
  e.AviaTooltip.openTTs = [];
  e.AviaTooltip.openTT_Elements = [];
  e.AviaTooltip.prototype = {
    bind_events: function () {
      ...
      e(i).addClass("av-perma-tooltip").trigger("av_permanent_show");
      this.scope.on(
      ...
      if (this.options.event != "click") {
        this.scope.on("mouseleave", t, this.hide_tooltip.bind(this));
        this.scope.on("click", t, this.hide_on_click_tooltip.bind(this));
      } else {
    ...
    start_countdown: function (t) {
      clearTimeout(this.timer);
      var a = this.options.event == "click" ? t.target : t.currentTarget,
        o = e(a);
      if (t.type == this.options.event) {
        var i =
          this.options.event == "click"
            ...
            : this.open
              ? 0
              : this.options.delay;
        this.timer = setTimeout(this.display_tooltip.bind(this, t), i);
      } else if (t.type == "mouseleave") {
        if (!o.hasClass("av-close-on-click-tooltip")) {
          this.timer = setTimeout(
            this.stop_instant_open.bind(this, t),
    ...
    display_tooltip: function (t) {
      let _self = this,
        target = this.options.event == "click" ? t.target : t.currentTarget,
        text = e(target).data(this.options.data);
      text = "string" == typeof text ? text.trim() : "";
      if (e("header").hasClass("av_header_transparency")) {
        if (text == "") {
      ...
      if (typeof tip_index != "undefined") {
        newTip = e.AviaTooltip.openTTs[tip_index];
      } else {
        this.inner.html(text);
        newTip = this.tooltip.clone();
        is_new_tip = !0;
        if (this.options.attach == "element" && force_append !== !0) {
      ...
      this.active = newTip;
      if (
        (newTip.is(":animated:visible") && t.type == "click") ||
      ...
      if (position == "top" || position == "bottom") {
        switch (align) {
          case "left":
            ...
            break;
          case "right":
            i = offset.left + element.outerWidth() - newTip.outerWidth();
            break;
          default:
            i =
        ...
        switch (align) {
          case "top":
            ...
            break;
          case "bottom":
            a = offset.top + element.outerHeight() - newTip.outerHeight();
            break;
          default:
            a =
      ...
      switch (position) {
        case "top":
          a = offset.top - newTip.outerHeight();
          o = {
            top: a - 10,
            left: i,
          };
          ...
          break;
        case "bottom":
          a = offset.top + element.outerHeight();
          o = {
            top: a + 10,
            left: i,
          };
          ...
          break;
        case "left":
          i = offset.left - newTip.outerWidth();
          o = {
            top: a,
            left: i - 10,
          };
          ...
          break;
        case "right":
          i = offset.left + element.outerWidth();
          o = {
            top: a,
            left: i + 10,
          };
      ...
      o["opacity"] = 0;
      s["opacity"] = 1;
      newTip.css(o).stop().animate(s, 200);
      newTip.find("input, textarea").trigger("focus");
      if (is_new_tip) {
        e.AviaTooltip.openTTs.push(newTip);
        e.AviaTooltip.openTT_Elements.push(element);
        element.data("avia-created-tooltip", e.AviaTooltip.openTTs.length - 1);
      }
    },
    hide_on_click_tooltip: function (t) {
      if (this.options.event == "click") {
        return;
      }
      ...
      var o = i.data("avia-created-tooltip");
      if ("undefined" != typeof o) {
        var a = e.AviaTooltip.openTTs[o];
        if ("undefined" != typeof a && a == this.active) {
          this.hide_all_tooltips();
        }
      }
    },
    close_on_keyup: function (t) {
      if (this.options.close_keys == null) {
        return;
      }
      if (e.inArray(t.keyCode, this.options.close_keys) < 0) {
        return;
      }
      this.hide_all_tooltips(t.keyCode);
    },
    hide_all_tooltips: function (t) {
      var o,
        s,
        n,
        r = "undefined" != typeof t ? t + "" : null;
      for (var a = 0; a < e.AviaTooltip.openTTs.length; ++a) {
        o = e.AviaTooltip.openTTs[a];
        n = e.AviaTooltip.openTT_Elements[a];
        s = n.data("avia-tooltip-position");
        if (r != null) {
          var i = o.data("close-keys");
    ...
    hide_tooltip: function (t) {
      var i = e(t.currentTarget),
        a,
        n,
        o = i.data("avia-tooltip-position"),
        s = i.data("avia-tooltip-alignment"),
        a = !1;
      ...
      if (this.options.event == "click") {
        i = e(t.target);
        if (
          !i.is("." + this.options["class"]) &&
          i.parents("." + this.options["class"]).length == 0
        ) {
        ...
        if (!i.hasClass("av-close-on-click-tooltip")) {
          ...
          a = typeof a != "undefined" ? e.AviaTooltip.openTTs[a] : !1;
        }
      }
      this.animate_hide_tooltip(a, o);
    },
    animate_hide_tooltip: function (e, t) {
      if (e) {
        var i = {
          opacity: 0,
        };
        switch (t) {
          case "top":
            i["top"] = parseInt(e.css("top"), 10) - 10;
            break;
          case "bottom":
            i["top"] = parseInt(e.css("top"), 10) + 10;
            break;
          case "left":
            i["left"] = parseInt(e.css("left"), 10) - 10;
            break;
          case "right":
            i["left"] = parseInt(e.css("left"), 10) + 10;
            break;
        }
        e.animate(i, 200, function () {
          e.css({
            display: "none",
          });
        });
...
jQuery.expr.pseudos.regex = function (e, t, i) {
  var a = i[3].split(","),
    o = /^(data|css):/,
    s = {
      method: a[0].match(o) ? a[0].split(":")[0] : "attr",
      property: a.shift().replace(o, ""),
    },
    n = "ig",
    r = new RegExp(a.join("").replace(/^\s+|\s+$/g, ""), n);
...
(function (i) {
  ...
  i.avia_utilities.activate_shortcode_scripts = function (e) {
    ...
    if (i.fn.aviaIconCircles) {
      i(".av-icon-circles-container").aviaIconCircles();
    }
    if (i.fn.avia_sc_icongrid) {
      i(".avia-icon-grid-container").avia_sc_icongrid();
    }
  };
  ...
  function n(e) {
    if (i.fn.avia_waypoints) {
      ...
      var t = i('*[class*="av-custom-animated-top-"]', e);
      t.each(function () {
        var n = i(this),
          t = n[0].className.split(/\s+/);
        for (var e = 0; e < t.length; e++) {
          if (t[e].indexOf("av-custom-animated-top-") == 0) {
            var a = parseInt(t[e].replace("av-custom-animated-top-", ""));
            if (!isNaN(a) && a < 100) {
              n.avia_waypoints({
                offset: a + "%",
              });
  ...
  i.fn.avia_browser_height = function () {
    ...
    var e = i(window),
      ...
      a = i("<style type='text/css' id='av-browser-height'></style>").appendTo(
        n,
      ),
    ...
    this.each(function (e) {
      let container = i(this),
        height = container.data("av_minimum_height_pc");
      if ("number" != typeof height) {
        return this;
      }
      height = parseInt(height);
      if (-1 == i.inArray(height, t) && height != 100) {
        t.push(height);
      }
      return this;
    });
  ...
  i.fn.avia_video_section = function () {
    ...
    var o = this.length,
      ...
      s = i(window),
      t = i("head").first(),
      a = i("<style type='text/css' id='av-section-height'></style>").appendTo(
        t,
      ),
      n = function (n, s) {
        if (s === 0) {
        ...
        if (o == s + 1) {
          try {
            ...
            a.remove();
            a = i(
              "<style type='text/css' id='av-section-height'>" + e + "</style>",
            ).appendTo(t);
          }
        }
      };
      ...
      i(this).on("click", function (e) {
        ...
        if ("undefined" !== typeof o || "_blank" == o) {
          ...
          if (t.hasClass("av-cell-link") || t.hasClass("av-column-link")) {
            var s = t.hasClass("av-cell-link")
              ? t.prev("a.av-screen-reader-only").first()
              : t.find("a.av-screen-reader-only").first();
            a = a.trim();
            if (
              0 == a.indexOf("#") ||
              (a.indexOf(r) >= 0 && a.indexOf("#") > 0)
            ) {
              s.trigger("click");
              if ("undefined" == typeof o || "_blank" != o) {
      ...
      setTimeout(function () {
        if (n && o && !a) {
          ...
          e.waypoint(function (e) {
            ...
            if (a.length) {
              t.addClass("avia_start_animation_when_active").trigger(
                "avia_start_animation_when_active",
              );
            }
            if (
              !a.length ||
              (a.length && a.is(".__av_init_open")) ||
              (a.length && a.is(".av-active-tab-content"))
            ) {
              t.addClass("avia_start_animation").trigger(
...
(function (i) {
  ...
  i.avia_utilities.playpause = function (e, t) {
    var a = {
      ...
      attach: function () {
        ...
        a.loading_item = i('<div class="avia_playpause_icon"></div>')
          .css({
            display: "none",
          })
          .appendTo(e);
  ...
  i.fn.avia_animate = function (e, a, t, n) {
    ...
    if (i.avia_utilities.supported.transition === undefined) {
      i.avia_utilities.supported.transition =
        i.avia_utilities.supports("transition");
    }
    if (i.avia_utilities.supported.transition !== !1) {
      var c = i.avia_utilities.supported.transition + "transition",
        ...
        o =
          u.WebkitTransition !== undefined
            ? "webkitTransitionEnd"
            : u.OTransition !== undefined
              ? "oTransitionEnd"
              : "transitionend";
      ...
      this.each(function () {
        ...
        if (v) {
          if (!(i.avia_utilities.supported.transition + "transform" in e)) {
            e[i.avia_utilities.supported.transition + "transform"] =
              "translateZ(0)";
          }
          var l = !1;
          t.on(o, function (i) {
...
(function (i) {
  ...
  i.fn.avia_swipe_trigger = function (e) {
    var r = i(window),
      t = i.avia_utilities.isMobile,
      n = i.avia_utilities.isTouchDevice,
      a = i("body"),
      o = {
        prev: ".prev-slide",
        next: ".next-slide",
      ...
      s = {
        activate_touch_control: function (i) {
          ...
          i.on("touchmove", function (o) {
            if (a.hasClass("avia-swipe-executed")) {
              return;
            }
            if (!i.touchPos.X) {
              i.touchPos.X = o.originalEvent.touches[0].clientX;
              i.touchPos.Y = o.originalEvent.touches[0].clientY;
            } else {
              t = o.originalEvent.touches[0].clientX - i.touchPos.X;
              n = o.originalEvent.touches[0].clientY - i.touchPos.Y;
              if (Math.abs(t) > Math.abs(n)) {
                if (i.touchPos !== o.originalEvent.touches[0].clientX) {
                  if (Math.abs(t) > 50) {
                    e = t > 0 ? "prev" : "next";
                    let element = i.options[e];
                    if (element == null) {
                      return;
                    }
                    if (typeof i.options.beforeTrigger == "function") {
                      i.options.beforeTrigger(i, e);
                    }
                    if (typeof i.options[e] === "string") {
                      i.find(i.options[e]).trigger(i.options.event[e], [
                        "swipe",
                      ]);
                    } else {
                      if (typeof element.jquery == "string") {
                        element.trigger(i.options.event[e], ["swipe"]);
                      } else {
                        let action = i.options.event[e];
                        if (action.indexOf("native_") < 0) {
                          element.dispatchEvent(new Event(action));
                        } else {
                          let func_action = action.replace("native_", "");
                          if (typeof element[func_action] == "function") {
                            if (i.options.delay_trigger) {
                              setTimeout(function () {
                                element[func_action]();
                                if (
                                  typeof i.options.afterDelayedTrigger ==
                                  "function"
                                ) {
                                  i.options.afterDelayedTrigger(i, e);
                                }
                              }, 50);
                            } else {
                              element[func_action]();
                    ...
                    if (typeof i.options.afterTrigger == "function") {
                      i.options.afterTrigger(i, e);
                    }
                    o.preventDefault();
                    o.stopImmediatePropagation();
                    a.addClass("avia-swipe-executed");
                    setTimeout(function () {
                      a.removeClass("avia-swipe-executed");
                    }, 300);
                    i.hasMoved = !0;
                    i.touchPos = {};
                    return !1;
    ...
    return this.each(function () {
      if (t || n) {
        var a = i(this);
        a.options = i.extend({}, o, e);
        s.activate_touch_control(a);
      }
    });
  };
})(jQuery);
(function (i) {
  ...
  function r(i) {
    ...
    if (i < 1 / e) {
      ...
      return a * (i -= 1.5 / e) * i + 0.75;
    } else if (i < 2.5 / e) {
      return a * (i -= 2.25 / e) * i + 0.9375;
    } else {
      return a * (i -= 2.625 / e) * i + 0.984375;
    }
  }
  i.extend(i.easing, {
    def: "easeOutQuad",
    ...
    easeInOutElastic: function (i) {
      return i === 0
        ...
        : i === 1
          ? 1
          : i < 0.5
            ? -(e(2, 20 * i - 10) * a((20 * i - 11.125) * v)) / 2
            : (e(2, -20 * i + 10) * a((20 * i - 11.125) * v)) / 2 + 1;
    },
...
(function (i) {
  ...
  i.AviaSlider.prototype = {
    ...
    _setOptions: function (s) {
      ...
      if ("object" == typeof o) {
        var t = i.extend({}, i.AviaSlider.defaults, s, o);
        if ("undefined" != typeof t.transition_speed) {
          t.transitionSpeed = t.transition_speed;
        }
        return t;
      }
      var t = i.extend(!0, {}, i.AviaSlider.defaults, s),
        a = this.$slider.data();
      for (var e in a) {
        var n = "transition_speed" != e ? e : "transitionSpeed";
        if (
          typeof a[e] === "string" ||
          typeof a[e] === "number" ||
          typeof a[e] === "boolean"
        ...
        if (
          "undefined" != typeof t.autoplay_stopper &&
          t.autoplay_stopper == 1
        ) {
          t.autoplay_stopper = !0;
        }
      }
      return t;
    },
    _prepareSlides: function (s) {
      var t = this.$slider.find(".avia-multi-slideshow-button");
      if (t.length) {
        t.on("click", function (s) {
          s.stopPropagation();
          var t = i.avia_utilities.loading(i(this));
          t.show();
        });
      }
      if (this.isMobile) {
        ...
        e.each(function () {
          var t = i(this).removeClass("av-video-slide").data({
              avia_video_events: !0,
              "video-ratio": 0,
            }),
            n = t.data("mobile-img"),
            e = t.data("fallback-link"),
            a = t.find(".avia-slide-wrap");
          t.find(
            ".av-click-overlay, .mejs-mediaelement, .mejs-container",
          ).remove();
          if (!n) {
            i(
          ...
          if (s && s.bg_slider) {
            ...
            if (e != "") {
              ...
              if (i.fn.avia_activate_lightbox) {
                t.parents("#main").avia_activate_lightbox();
              }
            }
          } else {
            ...
            if ("string" == typeof e && e.trim() != "") {
              if (a.is("a")) {
                ...
                var r =
                  e.match(/\.(jpg|jpeg|gif|png)$/i) != null
                    ? ' rel="lightbox" '
                    : "";
                o = '<a href="' + e.trim() + '"' + r + ">" + o + "</a>";
              }
              l = !0;
            }
            t.find(".avia-slide-wrap").append(o);
      ...
      if (i("html").is(".pointer-device-fine")) {
        if (i("body").is(".avia-slider-video-controls-fix-support")) {
    ...
    _getImageURLS: function () {
      ...
      this.$slides.each(function (t) {
        s.imageUrls[t] = [];
        s.imageUrls[t]["url"] = i(this).data("img-url");
        if (typeof s.imageUrls[t]["url"] == "string") {
          s.imageUrls[t]["status"] = !1;
        } else {
          s.imageUrls[t]["status"] = !0;
        }
      });
    },
    _preloadSingle: function (s, t) {
      var e = this,
        a = new Image();
      if (typeof e.imageUrls[s]["url"] == "string") {
        i(a).on("load error", function () {
          e.imageUrls[s]["status"] = !0;
          e.$slides
            .eq(s)
            .css("background-image", "url(" + e.imageUrls[s]["url"] + ")");
          if (typeof t == "function") {
            t.apply(e, [a, s]);
          }
        });
        if (e.imageUrls[s]["url"] != "") {
          a.src = e.imageUrls[s]["url"];
        } else {
          i(a).trigger("error");
        }
      } else {
    ...
    _bindEvents: function () {
      ...
      t._attach_video_events();
    },
    _kickOff: function () {
      var s = this,
        t = s.$slides.eq(0),
        e = t.data("video-ratio");
      s._bindEvents();
      ...
      if (this.options.carousel === "no") {
        ...
        t.css({
          ...
          function () {
            var t = i(this).addClass("active-slide");
    ...
    _buildCarousel: function () {
      ...
      if (
        ...
        for (var e in this.options.carouselResponsive) {
          var n = this.options.carouselResponsive[e]["breakpoint"],
            t =
              this.options.carouselResponsive[e]["settings"][
                "carouselSlidesToShow"
              ];
          if (n >= l) {
            s = parseInt(a / t);
            this.options.carouselSlidesToShow = t;
          }
        }
      }
    ...
    _navigate: function (i, s) {
      // Guard: stop if animating, not enough items, or slider hidden
      if (
        this.isAnimating ||
        this.itemsCount < 2 ||
      ...
      if (s !== undefined) {
        ...
        if (this.current === 0) {
          if (
            this.options.loop_autoplay !== "endless" &&
            this.options.loop_manual !== "manual-endless"
          ) {
            this.isAnimating = false;
            this.current = this.prev;
            return false;
    ...
    _setSize: function (i) {
      ...
      var n = this,
        ...
        t = o ? this.$sliderUl.width() / o : Math.floor(s.height()),
        e = s.data("video-height"),
    ...
    _setCenter: function () {
      var e = this.$slides.eq(this.current),
        o = e.find("img"),
        i = parseInt(o.css("min-width"), 10),
        s = e.width(),
        a = e.find(".av-slideshow-caption"),
        t = (s - i) / 2;
      if (a.length) {
    ...
    _slide: function (i) {
      ...
      if (this.cssActive) {
        ...
        if (this.css3DActive) {
          ...
          t[s] = "translate3d(" + n + "px, 0, 0)";
          e[s] = "translate3d(0,0,0)";
        } else {
          a[s] = "translate(" + o + "px,0)";
          t[s] = "translate(" + n + "px,0)";
          e[s] = "translate(0,0)";
        }
      } else {
        a.left = o;
    ...
    _slide_up: function (i) {
      ...
      if (this.cssActive) {
        ...
        if (this.css3DActive) {
          ...
          t[s] = "translate3d( 0," + n + "px, 0)";
          e[s] = "translate3d(0,0,0)";
        } else {
          a[s] = "translate( 0," + o + "px)";
          t[s] = "translate( 0," + n + "px)";
          e[s] = "translate(0,0)";
        }
      } else {
        a.top = o;
    ...
    _slide_animate: function (i, e, a) {
      ...
      if (!s.data("disableAutoplay")) {
        if (
          s.hasClass("av-video-lazyload") &&
          !s.hasClass("av-video-lazyload-complete")
        ) {
      ...
      s.css(i);
      o.avia_animate(e, this.options.transitionSpeed, this.options.easing);
      var n = function () {
        t.isAnimating = !1;
        ...
        t.$slider.trigger("avia-transition-done");
      };
      if (t.options.show_slide_delay > 0) {
        setTimeout(function () {
          s.addClass("next-active-slide");
          s.avia_animate(a, t.options.transitionSpeed, t.options.easing, n);
    ...
    _fade: function () {
      ...
      if (!i.data("disableAutoplay")) {
        if (
          i.hasClass("av-video-lazyload") &&
          !i.hasClass("av-video-lazyload-complete")
        ) {
    ...
    _attach_video_events: function () {
      ...
      s.$slides.each(function (t) {
        ...
        if (n.data("avia_video_events") != !0) {
          ...
          if (l && t === 0 && !n.data("disableAutoplay")) {
      ...
      function e(i) {
        if (i.data.iteration === 0) {
          ...
          t.is(".avia-msie") &&
          !i.data.slide.is(".av-video-service-html5")
        ) {
      ...
      function a(i) {
        if (
          !i.data.slide.is(".av-single-slide") &&
          !i.data.slide.is(".av-loop-video")
        ) {
    ...
    _timer: function (i, s, o) {
      ...
      this.resume = function () {
        e = new Date();
        t.timerId = window.setTimeout(i, a);
      };
    ...
    _setPermaCaptionPointer: function (s) {
      ...
      var t = i(this.$slides[this.current]).find("a").length;
      this.permaCaption.css("cursor", t ? "pointer" : "default");
    },
  ...
  i.fn.aviaSlider = function (s) {
    return this.each(function () {
      var t = i.data(this, "aviaSlider");
      if (!t) {
        t = i.data(this, "aviaSlider", new i.AviaSlider(s, this));
      }
    });
  };
})(jQuery);
...
(function (e) {
  "use strict";
  e.fn.avia_sc_gallery = function (a) {
    return this.each(function () {
      var t = e(this),
        r = t.find("img"),
        a = t.find(".avia-gallery-big"),
        s = t.find(".avia-slideshow-arrows .prev-slide"),
        n = t.find(".avia-slideshow-arrows .next-slide"),
        i = t.find(".avia-gallery-thumb a"),
        o = t.hasClass("no-hover-effect");
      if (n.length) {
        t.avia_swipe_trigger({
          prev: ".prev-slide",
          next: ".next-slide",
        });
      }
      ...
      if (t.hasClass("deactivate_avia_lazyload")) {
        t.trigger("avia_start_animation");
      }
      if (a.length) {
        t.on("mouseenter", ".avia-gallery-thumb a", function () {
          var i = e(this),
            c = i.attr("data-prev-img"),
            r = a.find("img"),
            l = r.attr("src");
          if (o) {
            if (!t.hasClass("av-force-img-change")) {
              return;
            }
          }
          t.removeClass("av-force-img-change");
          if (c == l) {
            return;
          }
          a.height(a.height());
          a.attr("data-onclick", i.attr("data-onclick"));
          a.attr("href", i.attr("href"));
          a.attr("title", i.attr("title"));
          if ("undefined" == typeof i.data("srcset")) {
            a.removeAttr("data-srcset");
            a.removeData("srcset");
          } else {
            a.data("srcset", i.data("srcset"));
            a.attr("data-srcset", i.data("srcset"));
          }
          if ("undefined" == typeof i.data("sizes")) {
            a.removeAttr("data-sizes");
            a.removeData("sizes");
          } else {
            a.data("sizes", i.data("sizes"));
            a.attr("data-sizes", i.data("sizes"));
          }
          var n = i.find(".big-prev-fake img").clone(!0);
          if (n.length == 0) {
            var s = new Image();
            s.src = c;
            n = e(s);
          }
          if (a.hasClass("avia-gallery-big-no-crop-thumb")) {
            n.css({
              height: "auto",
              width: "auto",
              "max-height": "100%",
        ...
        n.on("click", function (n) {
          ...
          let current = a[0].dataset.onclick,
            next_index = current;
          if (next_index >= i.length) {
            next_index = 0;
          }
          t.addClass("av-force-img-change");
          e(i[next_index]).trigger("mouseenter");
        });
        s.on("click", function (n) {
          ...
          if (prev_index < 0) {
            prev_index = i.length - 1;
          }
          t.addClass("av-force-img-change");
          e(i[prev_index]).trigger("mouseenter");
        });
        a.on("click", function (a) {
          ...
          if (e && !e.hasClass("aviaopeninbrowser")) {
            e.trigger("click");
          } else if (e) {
            var i = e.attr("href"),
              n = e.hasClass("custom_link") ? "noopener,noreferrer" : "";
            if (e.hasClass("aviablank") && i != "") {
              window.open(i, "_blank", n);
            } else if (i != "") {
              window.open(i, "_self", n);
            }
          }
          return !1;
        });
...
(function (e) {
  ...
  e.AviaVideoAPI.prototype = {
    ...
    _bind_player: function () {
      var t = this,
        o =
          e("html").hasClass("av-cookies-needs-opt-in") ||
          e("html").hasClass("av-cookies-can-opt-out"),
        i = !0,
      ...
      if (o && !n && !a) {
        if (
          ...
          e("html").hasClass("av-cookies-session-refused")
        ) {
          i = !1;
        } else {
      ...
      if (window["wp"] && wp.hooks) {
        i = wp.hooks.applyFilters("aviaCookieConsent_allow_continue", i);
      }
      let allow_class = i
        ? "avia-video-cookie-allowed"
        : "avia-video-cookie-not-allowed";
      e("html").addClass(allow_class);
      if (!i) {
    ...
    _playerReady: function () {
      ...
      setTimeout(function () {
        if (
          i.eventsBound == !0 ||
          typeof i.eventsBound == "undefined" ||
          i.type == "youtube"
        ) {
          return;
        }
        e.avia_utilities.log(
          'Fallback Video Trigger "' + i.type + '":',
          "log",
          i,
        );
        i.$option_container.trigger("av-video-loaded");
...
(function (i) {
  "use strict";
  i.AviaccordionSlider = function (t, e) {
    this.$slider = i(e);
    ...
    this.options = {};
    this.browserPrefix = i.avia_utilities.supported.transition;
    this.cssActive = this.browserPrefix !== !1 ? !0 : !1;
    this.transform3d =
      document.documentElement.className.indexOf("avia_transform3d") !== -1
        ? !0
  ...
  i.AviaccordionSlider.prototype = {
    _init: function (t) {
      var e = this;
      this.options = this._setOptions(t);
      i.avia_utilities.preload({
        container: this.$slider,
        single_callback: function () {
          e._kickOff();
    ...
    _setOptions: function (t) {
      var s = this.$slider.data("slideshow-options");
      if ("object" == typeof s) {
        var e = i.extend({}, i.AviaccordionSlider.defaults, t, s);
        return e;
      }
      var e = i.extend(
        {},
    ...
    _autoplay: function () {
      ...
      if (i.options.autoplay) {
        i.autoplay = setInterval(function () {
          i.open = i.open === !1 ? 0 : i.open + 1;
          if (i.open >= i.count) {
            if (i.options.loop_autoplay == "once") {
              clearInterval(i.autoplay);
      ...
      this.$images.each(function (t) {
        ...
        setTimeout(function () {
          s.avia_animate(
            ...
            function () {
              s.css(
                i.avia_utilities.supported.transition + "transform",
                "none",
              );
            },
          );
    ...
    _bindEvents: function () {
      var i = this.isMobile ? "click" : "mouseenter";
      this.$slider.on(i, ".aviaccordion-slide", this._move.bind(this));
      this.$slider.on(
        "mouseleave",
        ".aviaccordion-inner",
    ...
    _calcMovement: function (t, s) {
      var e = this,
        r = this.$slider.width(),
        p = this.$last.data("av-left"),
        c = this.$images.last().width() || r,
        a = Math.floor((100 / r) * c),
        l = a * e.count,
        h = 3,
        d = 100 - a,
        n = d > p / h ? d : 0,
      ...
      this.$slides.each(function (t) {
        ...
        l.data("av-calc-default", c);
        l.data("av-calc-left", s);
        l.data("av-calc-right", r);
      });
      if (e.increaseTitle) {
        e.$titles.css({
          width: v + "%",
    ...
    _moveTo: function (i) {
      var e = i.type == "av-next" ? 1 : -1,
        t = this.open === !1 ? 0 : this.open + e;
      if (t >= 0 && t < this.$slides.length) {
        this._move(i, t);
      }
    },
    _move: function (t, s) {
      var e = this,
        n = t.currentTarget,
        a = typeof s != "undefined" ? s : this.$slides.index(n);
      this.open = a;
      if (e.autoplay && typeof n != "undefined") {
        clearInterval(e.autoplay);
        e.autoplay = !1;
      }
      this.$slides.removeClass("aviaccordion-active-slide").each(function (s) {
        var n = i(this),
          c = n.data(),
          o = s <= a ? c.avCalcLeft : c.avCalcRight,
          r = {},
          l = t.type == "mouseleave" ? 1 : 0,
          h = a === s ? e.$titleWrap.eq(s) : !1;
        if (h) {
          n.addClass("aviaccordion-active-slide");
        }
        if (l) {
          o = c.avCalcDefault;
          this.open = !1;
        ...
        if (e.cssActive) {
          r[e.property] = e.transform3d
            ? "translate3d(" + o + "%, 0, 0)"
            : "translate(" + o + "%,0)";
          n.css(r);
        } else {
          r.left = o + "%";
          n.stop().animate(r, 700, "easeOutQuint");
        }
      });
    },
  };
  i.fn.aviaccordion = function (t) {
    return this.each(function () {
      var e = i.data(this, "AviaccordionSlider");
      if (!e) {
        i.data(this, "AviaccordionSlider", 1);
        new i.AviaccordionSlider(t, this);
      }
    });
  };
})(jQuery);
(function (t) {
  ...
  t.fn.avia_sc_tabs = function (e) {
    ...
    return this.each(function () {
      var a = t(this),
        c = t('<div class="tab_titles" role="tablist"></div>').prependTo(a),
        n = t(e.heading, a),
        r = t(e.content, a),
        o = !1,
        d = !1;
      o = n.clone();
      d = n.addClass("fullsize-tab").attr({
        "aria-hidden": !0,
        "aria-selected": !1,
        id: "",
        role: "",
      ...
      n = o;
      n.prependTo(c).each(function (e) {
        var a = t(this),
          i = !1;
        if (o) {
          i = d.eq(e);
        }
        a.addClass("tab_counter_" + e)
          .attr({
            tab_counter: e,
          })
          .on("click", function () {
      ...
      function l(n, l, o) {
        if (!n.is("." + e.active)) {
          ...
          t("." + e.active + "_content", a)
            .removeClass(e.active + "_content")
            .attr("aria-hidden", !0);
          n.addClass(e.active).attr({
            "aria-selected": !0,
            tabindex: 0,
          });
          var s = n.data("fake-id");
          if (typeof s == "string") {
          ...
          var d = r
            .eq(l)
            .addClass(e.active + "_content")
            .attr("aria-hidden", !1);
          if (typeof click_container != "undefined" && click_container.length) {
            sidebar_shadow.height(d.outerHeight());
          }
          var c = d.offset().top,
            f = c - 50 - parseInt(t("html").css("margin-top"), 10);
          if (i.scrollTop() > c) {
            t("html:not(:animated),body:not(:animated)").scrollTop(f);
          }
        }
        i.trigger("av-content-el-height-changed", n);
      }
      ...
      function f(t) {
        ...
        var e = n.filter('[data-fake-id="' + t + '"]');
        if (e.length) {
          if (!e.is(".active_tab")) {
            e.trigger("click");
          }
          window.scrollTo(0, a.offset().top - 70);
        }
      }
    });
  };
...
(function (i) {
  ...
  i("body").on(
    ...
    function (l) {
      var n = i(this),
        d =
          i("html").hasClass("av-cookies-needs-opt-in") ||
          i("html").hasClass("av-cookies-can-opt-out"),
        e = !0,
        c = i("html").hasClass("av-cookies-user-silent-accept");
      if (d && !c) {
        if (
          !document.cookie.match(/aviaCookieConsent/) ||
          i("html").hasClass("av-cookies-session-refused")
        ) {
          e = !1;
        } else {
          if (!document.cookie.match(/aviaPrivacyRefuseCookiesHideBar/)) {
      ...
      if (window["wp"] && wp.hooks) {
        e = wp.hooks.applyFilters("aviaCookieConsent_allow_continue", e);
      }
      var a = n.parents(".av-lazyload-video-embed");
      if (
        a.hasClass("avia-video-lightbox") &&
        a.hasClass("avia-video-standard-html")
      ) {
        e = !0;
      }
      if (!e) {
      ...
      if (a.hasClass("avia-video-lightbox")) {
        o = a.find("a.lightbox-link");
        if (o.length == 0) {
          a.append(s);
          setTimeout(function () {
            o = a.find("a.lightbox-link");
            if (i("html").hasClass("av-default-lightbox")) {
              o.addClass("lightbox-added").magnificPopup(
                i.avia_utilities.av_popup,
              );
              o.trigger("click");
            } else {
              o.trigger("avia-open-video-in-lightbox");
            }
          }, 100);
        } else {
          o.trigger("click");
...
(function (e) {
  ...
  function i() {
    var m = e("#header"),
      ...
      a = e("html").eq(0),
      n = e(
        '<div class="av-burger-overlay" role="menu" aria-orientation="vertical"></div>',
      ),
      ...
      y = !1,
      T = 0;
    if (!a.hasClass("html_av-submenu-hidden")) {
      a.addClass("html_av-submenu-visible");
    }
    ...
    var c = function () {
      ...
      o = function (i, u) {
        ...
        i.each(function () {
          ...
          v = t.find(".avia_mega_div > .sub-menu > li.menu-item");
          var i = t.find(">a"),
            c = !0;
          if (i.length) {
            if (
              i.get(0).hash == "#" ||
              "undefined" == typeof i.attr("href") ||
              i.attr("href") == "#"
            ) {
          ...
          if ("undefined" != typeof t.attr("class")) {
            ...
            e.each(l, function (e, i) {
              if (
                i.indexOf("menu-item") != 0 &&
                i.indexOf("page-item") < 0 &&
                i.indexOf("page_item") != 0 &&
                i.indexOf("dropdown_ul") < 0
              ) {
                a.addClass(i);
              }
              return !0;
          ...
          if (r.length) {
            ...
            if (d && s.get(0).hash != "#" && s.attr("href") != "#") {
              a.clone(!0).prependTo(n);
            }
            a.addClass("av-width-submenu")
              .find(">a")
    ...
    e("body").on(
      ...
      function (e) {
        ...
        if (i != this.clientHeight) {
          if (
            (this.scrollTop >= i - n && a < 0) ||
            (this.scrollTop <= 0 && a > 0)
          ) {
            e.preventDefault();
          }
        } else {
    ...
    e(window).on("debouncedresize", function (n) {
      var s = !0;
      if (
        e.avia_utilities.isMobile &&
        a.hasClass("av-mobile-menu-switch-portrait") &&
        a.hasClass("html_text_menu_active")
      ) {
    ...
    e(".html_av-submenu-display-hover").on(
      "mouseenter",
      ".av-width-submenu",
      function (i) {
    ...
    e(".html_av-submenu-display-click").on(
      "click",
      ".av-width-submenu > a",
      function (i) {
        var a = e(this);
    ...
    e(".html_av-submenu-display-click, .html_av-submenu-visible").on(
      "click",
      ".av-burger-overlay a",
      function (a) {
    ...
    l.on("click", function (t) {
      ...
      if (!y) {
        ...
        var d = h.find("> li:not(.menu-item-avia-special)"),
          f = o(d, s);
        s.find(".noMobile").remove();
        s.appendTo(g);
        v = g.find("#av-burger-menu-ul > li");
        if (e.fn.avia_smoothscroll) {
      ...
      if (i.is(".is-active")) {
        ...
        c();
        var l = u.length
          ? u.outerHeight() + u.position().top
          : m.outerHeight() + m.position().top;
        n.appendTo(e(t.target).parents(".avia-menu"));
        s.css({
          padding: l + "px 0px",
        });
        v.removeClass("av-active-burger-items");
...
(function (t) {
  ...
  var i = function (i, e) {
    ...
    this.win = t(window);
    this.body = t("body");
    ((this.isMobile = t.avia_utilities.isMobile),
    ...
    if (t.avia_utilities.supported.transition === undefined) {
      t.avia_utilities.supported.transition =
        t.avia_utilities.supports("transition");
    }
    this._init(i);
  };
  i.prototype = {
    ...
    _parallaxScroll: function (i) {
      ...
      if ("background-image" == this.objectType) {
        if (
          this.elProperty.top < s &&
          l <= this.elProperty.top + this.elProperty.height
        ) {
      ...
      var f = this._inViewport(
        ...
        c = this._inViewport(
          this.elProperty.top + r.y,
          this.elProperty.right + r.x,
          this.elProperty.bottom + r.y,
          this.elProperty.left + r.x,
          l,
          s,
          o,
          d,
  ...
  if (!avia_js_shortcodes.aviaFoldUnfoldSection) {
    class avFoldUnfoldSection {
      ...
      init() {
        ...
        if (
          !this.button.length ||
          !this.foldContainer.length ||
          this.checkMissingInnerContainers()
        ) {
          return;
        }
        if (this.isNested()) {
      ...
      moveIntoFoldContainer() {
        ...
        if (this.settings.context == "avia_sc_text") {
          ...
          let el = this.foldContainer[0].nextSibling;
          this.column = this.foldContainer[0].getElementsByClassName(
            "av-fold-unfold-inner",
          );
          if (this.column.length) {
            while (el) {
              if (
                el.classList &&
                el.classList.contains("av-fold-button-wrapper")
              ) {
                el = el.nextSibling;
              } else {
      ...
      checkMissingInnerContainers() {
        ...
        switch (this.settings.context) {
          case "avia_sc_text":
            this.textblock =
              this.container.getElementsByClassName("avia_textblock");
            if (this.textblock.length == 0) {
              retVal = !0;
            } else {
              this.multiColumsTextblock =
                this.textblock[0].classList.contains("av_multi_colums");
            }
            break;
          case "avia_sc_grid_row":
            this.gridRow = this.container.getElementsByClassName(
          ...
          case "avia_sc_section":
            this.colorSection =
              this.container.getElementsByClassName("avia-section");
      ...
      bindEvents() {
        ...
        this.button[0].addEventListener(
          "click",
          this.onClickFoldUnfold.bind(this),
        );
        window.addEventListener(
          "avia_fold_unfold_changed",
          this.onFoldUnfoldChanged.bind(this),
        );
        window.addEventListener(
          "resize",
          aviaJS.aviaJSHelpers.debounce(this.onResize.bind(this), 200),
        );
      }
      getMaxHeight() {
        switch (this.settings.context) {
      ...
      foldChanged() {
        let btnText = "",
          btnLink = "";
        if (this.folded) {
          this.foldContainer[0].style["max-height"] =
          ...
          this.getMaxHeight();
          this.foldContainer[0].style["max-height"] =
            Math.ceil(this.innerDimension.height) + 200 + "px";
    ...
    avia_js_shortcodes.aviaFoldUnfoldSection = function (t) {
      return new avFoldUnfoldSection(t);
    };
    aviaJS.aviaPlugins.register(
...
!(function (e) {
        ...
        if ((S(), i.src)) {
          ...
          if (a.length) {
            ...
            (r &&
              ...
              (z = a.after(_).detach().removeClass(T))),
  ...
  e.magnificPopup.registerModule(F, {
    options: {
      markup:
        '<div class="mfp-iframe-scaler"><div class="mfp-close"></div><iframe class="mfp-iframe" src="//about:blank" frameborder="0" allowfullscreen allow="autoplay; encrypted-media" ></iframe></div>',
        ...
        if (((i = N(i)), !t.items[i].preloaded)) {
          ...
          if (
            ...
            var o = e(n.el[0]),
              ...
              r = o.data("sizes");
            if (void 0 !== a)
              (n.img.attr("srcset", a), void 0 !== r && n.img.attr("sizes", r));
            else {
              var s = e(n.el[0]).find("img");
              (void 0 !== (a = s.attr("srcset")) && n.img.attr("srcset", a),
                void 0 !== (r = s.attr("sizes")) && n.img.attr("sizes", r));
            }
          }
          n.preloaded = !0;
        }
...
(function (e) {
  ...
  e.avia_utilities.av_popup = {
    ...
    midClick: !0,
    autoFocusLast: !1,
    fixedContentPos: e("html").hasClass("av-default-lightbox-no-scroll"),
    iframe: {
      patterns: {
        youtube: {
        ...
        youtube_shorts: {
          ...
          id: function (e) {
            let m = e.match(/(?:youtube\.com\/shorts\/)([a-zA-Z0-9_-]*)/),
              id,
              params;
            if (!m || !m[1]) {
              return null;
        ...
        vimeo: {
          ...
          id: function (e) {
            let m = e.match(
                /(https?:\/\/)?(www.)?(player.)?vimeo.com\/([a-z]*\/)*([0-9]{6,11})\/(\w{6,11})[?]?.*/,
              ),
              params,
              vid;
            m = m
    ...
    callbacks: {
      beforeOpen: function () {
        ...
        if (this.st.el && this.st.el.data("custom_class")) {
          ...
          let element = e(this.st.el),
            href = element.attr("href");
          if (
            href.indexOf("youtube.com") >= 0 &&
            href.indexOf("/shorts/") >= 0
          ) {
      ...
      markupParse: function (t, a, r) {
        if (
          typeof a.img_replaceWith == "undefined" ||
          typeof a.img_replaceWith.length == "undefined" ||
          a.img_replaceWith.length == 0
        ) {
          return;
        }
      ...
      change: function () {
        if (this.currItem.el) {
          ...
          if (e.data("av-extra-content")) {
            ...
            this.content.append(
              "<div class='av-extra-modal-content'>" + a + "</div>",
            );
          }
          if (e.data("av-extra-markup")) {
            var t = e.data("av-extra-markup");
            this.wrap.append(
              "<div class='av-extra-modal-markup'>" + t + "</div>",
            );
          }
        }
      },
  ...
  e.fn.avia_activate_lightbox = function (t) {
    var i = {
        ...
        autolinkElements:
          'a.lightbox, a[rel^="prettyPhoto"], a[rel^="lightbox"], a[href$=jpg], a[href$=webp], a[href$=png], a[href$=gif], a[href$=jpeg], a[href*=".jpg?"], a[href*=".png?"], a[href*=".gif?"], a[href*=".jpeg?"], a[href$=".mov"] , a[href$=".swf"] , a:regex(href, .vimeo\.com/[0-9]) , a[href*="youtube.com/watch"] , a[href*="youtube.com/shorts"] , a[href*="screenr.com"], a[href*="iframe=true"]',
        videoElements:
          'a[href$=".mov"] , a[href$=".swf"] , a:regex(href, .vimeo\.com/[0-9]) , a[href*="youtube.com/watch"] , a[href*="youtube.com/shorts"] , a[href*="screenr.com"], a[href*="iframe=true"]',
        exclude:
          '.noLightbox, .noLightbox a, .fakeLightbox, .lightbox-added, a[href*="dropbox.com"], .pagination a',
      },
      a = e.extend({}, i, t),
    ...
    return this.each(function () {
      ...
      for (var t = 0; t < a.groups.length; t++) {
        i.find(a.groups[t]).each(function () {
          ...
          if (r) {
            t.removeClass("lightbox-added");
          }
          t.not(a.exclude)
            .addClass("lightbox-added")
            .magnificPopup(e.avia_utilities.av_popup);
        });
      }
    });
  };
...
(function (e) {
  ...
  function i() {
    var h = e(window),
      i = e(".html_header_top.html_header_sticky #header"),
      r = e(".av_header_unstick_top");
    ...
    var u = e(
      ...
      t = e(o).first().height(),
      v = e.avia_utilities.isMobile,
      H = e("#scroll-top-link"),
      f = i.is(".av_header_transparency"),
      s = i.is(".av_header_shrinking"),
      c = i.data("av_shrink_factor"),
      l = t / 2.0,
      g = t / 2.0,
      p = i.find("#header_meta"),
      n = p.length ? p.outerHeight() : 0,
      m = i.find("#header_main_alternate"),
      y = m.length ? m.outerHeight() : 0,
      d = function () {
        var d = h.scrollTop(),
          c = 0,
          p = d;
        ...
        if (s && !v) {
          if (d < l) {
            ...
            a(i, "remove", "header-scrolled");
          } else {
            c = g;
            a(i, "add", "header-scrolled");
          }
          if (d - 30 < t) {
            a(i, "remove", "header-scrolled-full");
          } else {
            a(i, "add", "header-scrolled-full");
          }
          o.css({
            height: c + "px",
            lineHeight: c + "px",
          ...
          if (i.length) {
            if (!r.length) {
              ...
              if (d <= n) {
                propHeight = propHeight + n - p;
              }
            }
          }
          e(":root")[0].style.setProperty(
            "--enfold-header-height",
            Math.round(propHeight) + "px",
          );
        }
        if (r.length) {
          if (d <= 0) {
        ...
        if (f) {
          if (d > 50) {
            a(i, "remove", "av_header_transparency");
          } else {
            a(i, "add", "av_header_transparency");
          }
        }
      };
    ...
    if (e("body").is(".avia_deactivate_menu_resize")) {
      s = !1;
    }
    if (!f && !s && !r.length) {
      return;
    }
    h.on("debouncedresize", function () {
      t = e(o).attr("style", "").first().height();
      d();
    });
