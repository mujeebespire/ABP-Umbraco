...
$.validator.unobtrusive.adapters.add(
  ...
  function (n) {
    n.rules.requiredif = {
      ...
      targetvalue: n.params.targetvalue,
    };
...
addjQueryValidatorMethod(
  "filelistmaxsizeattribute",
  ["combinedmaxlengthinbytes"],
  function (n, t, i) {
    for (
      var e = parseInt(i.combinedmaxlengthinbytes), u = 0, f, r = 0;
      r < t.files.length;
      r++
    )
